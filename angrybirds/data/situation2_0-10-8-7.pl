...
hasMaterial(stone15,stone,599,370,25,6).
hasMaterial(stone16,stone,606,376,16,7).
hasMaterial(stone17,stone,622,377,9,6).
...
shape(stone15,rect, 611.5,373,150,[6,25,0]).
shape(stone16,rect, 614,379.5,112,[7,16,0]).
shape(stone17,rect, 626.5,380,54,[6,9,0]).
...
situation_name('situation1_0-10-8-7').
