...
shape(redbird1,ball, 131,370.5,86,[5.25]).
...
shape(stone7,rect, 409,312.5,148,[5.91889296,25.07726574,1.66504411]).
shape(stone8,rect, 422,340.5,150,[6,25,1.57079633]).
shape(wood11,rect, 533.5,198,150,[6,25,0]).
situation_name('situation1_0-7-1-0').
