...
hasMaterial(stone13,stone,577,377,25,6).
hasMaterial(stone14,stone,747,377,16,6).
hasMaterial(stone15,stone,763,377,9,6).
...
isAnchorPointFor(stone14,struct6).
isBelow(ice11,hill2).
isBelow(ice6,stone0).
...
shape(ice12,rect, 507,228.5,295,[5.84549254,50.5460986,2.136283]).
...
shape(stone13,rect, 589.5,380,150,[6,25,0]).
shape(stone14,rect, 755,380,96,[6,16,0]).
shape(stone15,rect, 767.5,380,54,[6,9,0]).
...
situation_name('situation1_0-10-8-7-14').
