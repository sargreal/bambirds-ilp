...
hasMaterial(stone2,stone,388,336,26,7).
hasMaterial(stone3,stone,390,330,24,7).
hasMaterial(stone4,stone,391,299,6,25).
...
shape(stone2,rect, 401,339.5,182,[7,26,0]).
shape(stone3,rect, 402,333.5,168,[7,24,0]).
shape(stone4,rect, 394,311.5,150,[6,25,1.57079633]).
...
situation_name('situation1_0-9-0-1').
