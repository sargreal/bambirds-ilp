...
hasMaterial(ice11,ice,480,198,13,5).
hasMaterial(ice12,ice,489,201,11,50).
hasMaterial(ice14,ice,521,200,0,0).
...
hasMaterial(stone15,stone,559,358,5,25).
...
isAnchorPointFor(ice14,struct5).
...
shape(ice11,poly, 499,199,65,[6,[480,201],[481,202],[488,203],[490,202],[493,199],[485,198]]).
shape(ice12,rect, 494.5,226,340,[6.80549726,50.06042317,1.47654855]).
shape(ice14,poly, 527,199,0,[1,[521,200]]).
...
shape(stone15,rect, 561.5,370.5,125,[5,25,1.57079633]).
...
situation_name('situation1_0-7-8-2-8').
