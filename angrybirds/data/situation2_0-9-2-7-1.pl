...
hasMaterial(stone10,stone,450,234,25,17).
hasMaterial(stone12,stone,467,245,24,6).
hasMaterial(stone2,stone,389,299,6,25).
hasMaterial(stone3,stone,390,336,24,7).
hasMaterial(stone4,stone,391,330,25,6).
...
hasMaterial(stone9,stone,427,239,26,12).
...
shape(stone10,rect, 462.5,242.5,135,[5.5157839,24.59603903,2.67035376]).
shape(stone12,rect, 479,248,144,[6,24,0]).
shape(stone2,rect, 392,311.5,150,[6,25,1.57079633]).
shape(stone3,rect, 402,339.5,168,[7,24,0]).
shape(stone4,rect, 403.5,333,150,[6,25,0]).
...
shape(stone9,rect, 440,245,151,[6.11254163,24.73813519,2.89026524]).
situation_name('situation1_0-9-2-7-1').
