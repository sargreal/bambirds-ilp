...
hasMaterial(stone11,stone,467,232,24,6).
hasMaterial(stone12,stone,476,244,24,7).
hasMaterial(stone13,stone,476,238,25,6).
...
shape(stone11,rect, 479,235,144,[6,24,0]).
shape(stone12,rect, 488,247.5,168,[7,24,0]).
shape(stone13,rect, 488.5,241,150,[6,25,0]).
...
situation_name('situation1_0-7-4-11').
