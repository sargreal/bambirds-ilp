...
hasForm(stone9,bar).
hasMaterial(ice11,ice,452,306,6,50).
...
hasMaterial(stone12,stone,460,245,25,6).
hasMaterial(stone13,stone,531,189,25,6).
hasMaterial(stone14,stone,539,195,24,6).
...
shape(ice11,rect, 455,331,300,[6,50,1.57079633]).
...
shape(stone12,rect, 472.5,248,150,[6,25,0]).
shape(stone13,rect, 543.5,192,150,[6,25,0]).
shape(stone14,rect, 551,198,144,[6,24,0]).
...
situation_name('situation1_0-4-3').
