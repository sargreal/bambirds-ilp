...
hasMaterial(stone13,stone,468,228,24,16).
hasMaterial(stone14,stone,482,237,25,16).
...
shape(redbird2,ball, 129.5,370,103,[5.75]).
...
shape(stone13,rect, 480,236,134,[5.48223078,24.58976736,2.70176968]).
shape(stone14,rect, 494.5,245,157,[6.2879691,25.03305505,0.4712389]).
...
situation_name('situation1_0-4-6').
