...
hasForm(stone8,bar).
hasForm(wood15,bar).
hasMaterial(ice11,ice,496,228,11,14).
hasMaterial(ice13,ice,501,217,15,14).
...
hasMaterial(stone10,stone,492,197,26,11).
hasMaterial(stone12,stone,498,206,18,21).
hasMaterial(stone14,stone,512,187,25,9).
...
hasMaterial(stone6,stone,397,299,6,25).
hasMaterial(stone7,stone,404,300,6,24).
hasMaterial(stone8,stone,411,299,6,25).
hasMaterial(wood15,wood,528,195,25,6).
...
shape(ice11,rect, 501.5,235,68,[4.9259976,13.87001179,2.04203522]).
shape(ice13,rect, 508.5,224,85,[6.36396103,13.43502884,2.35619449]).
...
shape(stone10,rect, 505,202.5,142,[5.83767535,24.4894453,2.89026524]).
shape(stone12,rect, 507,216.5,102,[4.17934299,24.56104696,2.23053078]).
shape(stone14,rect, 524.5,191.5,164,[6.53802167,25.17137406,3.04734487]).
...
shape(stone6,rect, 400,311.5,150,[6,25,1.57079633]).
shape(stone7,rect, 407,312,144,[6,24,1.57079633]).
shape(stone8,rect, 414,311.5,150,[6,25,1.57079633]).
shape(wood15,rect, 540.5,198,150,[6,25,0]).
situation_name('situation1_0-10-6-5-7').
