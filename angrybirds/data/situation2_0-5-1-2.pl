...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice11,ice,496,218,6,31).
...
hasMaterial(stone10,stone,461,245,24,6).
hasMaterial(stone13,stone,510,171,5,24).
hasMaterial(stone14,stone,517,170,5,25).
...
hasMaterial(wood12,wood,502,194,25,9).
...
shape(ice11,rect, 499,233.5,186,[6,31,1.57079633]).
...
shape(stone10,rect, 473,248,144,[6,24,0]).
shape(stone13,rect, 512.5,183,120,[5,24,1.57079633]).
shape(stone14,rect, 519.5,182.5,125,[5,25,1.57079633]).
...
shape(wood12,rect, 514.5,198.5,174,[6.96893375,25.07726574,3.04734487]).
situation_name('situation1_0-5-1-2').
