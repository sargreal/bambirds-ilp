...
hasMaterial(ice13,ice,492,247,6,4).
hasMaterial(ice14,ice,496,228,11,19).
...
hasMaterial(stone11,stone,475,236,16,14).
hasMaterial(stone12,stone,489,232,8,9).
hasMaterial(stone15,stone,516,196,24,5).
hasMaterial(stone16,stone,561,377,25,6).
hasMaterial(stone2,stone,389,281,25,7).
hasMaterial(stone3,stone,389,250,7,25).
hasMaterial(stone4,stone,390,288,24,6).
...
isOver(ice14,pig0).
isOver(stone15,pig0).
isRight(ice13,stone11).
isRight(ice14,stone12).
...
shape(ice13,poly, 495,247,24,[4,[492,247],[492,248],[495,251],[498,250]]).
shape(ice14,poly, 502,238,104.5,[5,[496,246],[498,247],[507,230],[505,228],[497,238]]).
...
shape(redbird2,ball, 128,373,95,[5.5]).
shape(stone0,rect, 401.5,304,150,[6,25,0]).
shape(stone1,rect, 401.5,297.5,175,[7,25,0]).
shape(stone11,rect, 483,243,74,[4.46759733,16.57833366,2.4818582]).
shape(stone12,rect, 493,236.5,35,[4.94974747,7.07106781,2.35619449]).
shape(stone15,rect, 528,198.5,120,[5,24,0]).
shape(stone16,rect, 573.5,380,150,[6,25,0]).
shape(stone2,rect, 401.5,284.5,175,[7,25,0]).
shape(stone3,rect, 392.5,262.5,175,[7,25,1.57079633]).
shape(stone4,rect, 402,291,144,[6,24,0]).
...
situation_name('situation1_0-8-22').
