...
hasMaterial(stone11,stone,561,377,25,6).
hasMaterial(stone12,stone,586,370,26,13).
...
shape(stone11,rect, 573.5,380,150,[6,25,0]).
shape(stone12,rect, 599,376.5,156,[6.38444507,24.44200399,0.28274334]).
...
situation_name('situation1_0-8-8-9').
