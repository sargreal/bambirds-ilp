...
hasMaterial(ice11,ice,497,206,27,45).
...
hasMaterial(stone12,stone,512,195,24,6).
hasMaterial(stone13,stone,528,184,23,18).
...
shape(ice11,rect, 510.5,228.5,337,[7.18534795,46.9973698,2.0106193]).
...
shape(stone12,rect, 524,198,144,[6,24,0]).
shape(stone13,rect, 539.5,193,114,[4.69748625,24.41077878,0.5969026]).
...
situation_name('situation1_0-8-9').
