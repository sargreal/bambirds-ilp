...
hasMaterial(stone10,stone,441,244,25,7).
hasMaterial(stone11,stone,450,238,25,6).
hasMaterial(stone13,stone,484,226,14,25).
...
shape(ice14,rect, 503,225.5,276,[6.07929493,45.50225718,1.94778745]).
...
shape(stone10,rect, 453.5,247.5,175,[7,25,0]).
shape(stone11,rect, 462.5,241,150,[6,25,0]).
shape(stone13,rect, 491,238.5,151,[6.14031085,24.69798015,1.94778745]).
...
shape(stone7,rect, 400.5,262.5,166,[6.5925005,25.26548237,1.66504411]).
...
situation_name('situation1_0-2-16-5-5').
