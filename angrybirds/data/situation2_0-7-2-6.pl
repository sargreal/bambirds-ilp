...
hasMaterial(ice12,ice,491,215,12,33).
hasMaterial(ice13,ice,500,202,4,15).
...
hasMaterial(stone11,stone,461,245,23,6).
hasMaterial(stone15,stone,509,171,6,24).
hasMaterial(stone16,stone,516,170,6,25).
...
hasMaterial(wood14,wood,502,194,25,9).
...
shape(ice12,rect, 497,231.5,225,[6.80646547,33.06301863,1.72787596]).
shape(ice13,rect, 502,209.5,60,[4,15,1.57079633]).
...
shape(stone11,rect, 472.5,248,138,[6,23,0]).
shape(stone15,rect, 512,183,144,[6,24,1.57079633]).
shape(stone16,rect, 519,182.5,150,[6,25,1.57079633]).
...
shape(wood14,rect, 514.5,198.5,166,[6.61606557,25.13903977,3.0787608]).
situation_name('situation1_0-7-2-6').
