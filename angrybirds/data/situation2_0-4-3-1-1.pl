...
hasForm(stone8,bar).
hasForm(stone9,bar).
hasMaterial(ice10,ice,449,344,5,11).
hasMaterial(ice11,ice,449,304,7,39).
...
hasMaterial(stone12,stone,462,244,24,7).
hasMaterial(stone13,stone,465,231,25,6).
hasMaterial(stone14,stone,470,236,25,8).
...
shape(ice10,rect, 451.5,349.5,55,[5,11,1.57079633]).
shape(ice11,rect, 452.5,323.5,273,[7,39,1.57079633]).
...
shape(stone12,rect, 474,247.5,168,[7,24,0]).
shape(stone13,rect, 477.5,234,150,[6,25,0]).
shape(stone14,rect, 482.5,240,200,[8,25,0]).
...
situation_name('situation1_0-4-3-1-1').
