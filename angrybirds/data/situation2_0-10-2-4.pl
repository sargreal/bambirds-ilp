...
hasForm(stone9,bar).
hasForm(wood14,bar).
hasMaterial(ice11,ice,455,304,6,39).
hasMaterial(ice13,ice,492,203,22,45).
...
hasMaterial(stone12,stone,484,226,5,25).
hasMaterial(stone2,stone,385,310,23,20).
hasMaterial(stone3,stone,388,350,25,6).
hasMaterial(stone4,stone,388,305,23,21).
...
hasMaterial(wood14,wood,507,193,27,11).
...
shape(ice11,rect, 458,323.5,234,[6,39,1.57079633]).
shape(ice13,rect, 503,225.5,304,[6.70196278,45.50225718,1.94778745]).
...
shape(stone12,rect, 486.5,238.5,125,[5,25,1.57079633]).
shape(stone2,rect, 396.5,320,137,[5.55689254,24.83310017,0.72256631]).
shape(stone3,rect, 400.5,353,150,[6,25,0]).
shape(stone4,rect, 399.5,315.5,142,[5.90272502,24.1717883,0.72256631]).
...
shape(wood14,rect, 520.5,198.5,165,[6.54267809,25.31794638,2.98451302]).
situation_name('situation1_0-10-2-4').
