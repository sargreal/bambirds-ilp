...
hasMaterial(ice14,ice,488,227,21,25).
...
hasMaterial(stone11,stone,429,245,25,6).
hasMaterial(stone13,stone,461,245,23,5).
hasMaterial(stone15,stone,520,196,25,5).
...
shape(ice14,rect, 498.5,239.5,161,[6.02317429,26.8363844,2.19911486]).
...
shape(stone11,rect, 441.5,248,150,[6,25,0]).
shape(stone13,rect, 472.5,247.5,115,[5,23,0]).
shape(stone15,rect, 532.5,198.5,125,[5,25,0]).
...
situation_name('situation1_0-9-14').
