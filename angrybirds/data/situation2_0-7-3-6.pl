...
hasMaterial(stone8,stone,402,250,11,26).
...
shape(stone8,rect, 407.5,263,162,[6.65922082,24.33025803,1.72787596]).
shape(stone9,rect, 414,263.5,150,[6,25,1.57079633]).
shape(wood15,rect, 550.5,198,150,[6,25,0]).
situation_name('situation1_0-7-3-6').
