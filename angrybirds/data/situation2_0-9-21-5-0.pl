...
hasMaterial(stone10,stone,604,370,25,6).
hasMaterial(stone11,stone,608,377,25,6).
...
shape(stone10,rect, 616.5,373,150,[6,25,0]).
shape(stone11,rect, 620.5,380,150,[6,25,0]).
...
situation_name('situation1_0-9-21-5-0').
