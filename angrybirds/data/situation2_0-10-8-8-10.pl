...
hasMaterial(ice12,ice,487,195,34,6).
hasMaterial(ice13,ice,490,202,9,49).
...
hasMaterial(stone15,stone,525,180,19,22).
hasMaterial(stone16,stone,680,377,22,6).
...
hasMaterial(wood14,wood,502,189,25,6).
...
shape(ice12,rect, 504,198,204,[6,34,0]).
shape(ice13,rect, 494.5,226.5,317,[6.46256302,49.10146449,1.60221225]).
...
shape(stone15,rect, 534.5,191,108,[4.49130208,24.26058751,0.84823002]).
shape(stone16,rect, 691,380,132,[6,22,0]).
...
shape(wood14,rect, 514.5,192,150,[6,25,0]).
situation_name('situation1_0-10-8-8-10').
