...
hasMaterial(stone0,stone,389,300,25,9).
...
hasMaterial(stone3,stone,389,282,26,7).
hasMaterial(stone4,stone,389,251,7,25).
hasMaterial(stone5,stone,391,276,24,6).
hasMaterial(stone7,stone,398,251,6,25).
hasMaterial(stone8,stone,404,251,7,25).
hasMaterial(stone9,stone,411,252,6,24).
...
shape(stone0,rect, 401.5,304.5,157,[6.21606725,25.26548237,0.09424778]).
...
shape(stone2,rect, 401.5,291.5,172,[6.87090289,25.05048553,0.03141593]).
shape(stone3,rect, 402,285.5,182,[7,26,0]).
shape(stone4,rect, 392.5,263.5,175,[7,25,1.57079633]).
shape(stone5,rect, 403,279,144,[6,24,0]).
shape(stone7,rect, 401,263.5,150,[6,25,1.57079633]).
shape(stone8,rect, 407.5,263.5,175,[7,25,1.57079633]).
shape(stone9,rect, 414,264,144,[6,24,1.57079633]).
shape(wood16,rect, 550.5,198,150,[6,25,0]).
situation_name('situation1_0-5-2-8').
