...
hasMaterial(ice12,ice,492,244,5,5).
hasMaterial(ice15,ice,496,220,20,29).
...
hasMaterial(stone13,stone,493,200,17,23).
hasMaterial(stone14,stone,496,209,17,22).
hasMaterial(stone16,stone,507,194,25,7).
...
hasMaterial(wood17,wood,538,195,25,6).
...
shape(ice12,ball, 495.5,247.5,50,[4]).
shape(ice15,rect, 506,234.5,204,[6.91895277,29.52852512,2.07345115]).
shape(ice7,rect, 401,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 144.5,373.5,95,[5.5]).
...
shape(stone13,rect, 501.5,211.5,113,[4.59511549,24.77781024,2.136283]).
shape(stone14,rect, 504.5,220,101,[4.18923816,24.16080798,2.136283]).
shape(stone16,rect, 519.5,197.5,148,[5.92536985,25.13903977,0.06283185]).
...
shape(wood17,rect, 550.5,198,150,[6,25,0]).
situation_name('situation1_0-5-6').
