...
hasForm(stone8,bar).
hasForm(stone9,bar).
hasMaterial(ice10,ice,453,305,6,51).
...
hasMaterial(stone11,stone,479,245,24,6).
hasMaterial(stone12,stone,516,196,24,5).
...
shape(ice10,rect, 456,330.5,306,[6,51,1.57079633]).
...
shape(stone11,rect, 491,248,144,[6,24,0]).
shape(stone12,rect, 528,198.5,120,[5,24,0]).
...
situation_name('situation1_0-8-22-1').
