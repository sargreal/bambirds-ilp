...
hasMaterial(ice12,ice,495,245,5,5).
hasMaterial(ice13,ice,498,227,12,18).
...
hasMaterial(stone14,stone,599,370,25,6).
hasMaterial(stone15,stone,606,376,16,7).
hasMaterial(stone16,stone,622,377,9,6).
...
hasMaterial(wood11,wood,489,226,17,24).
...
isAnchorPointFor(wood11,struct2).
isBelow(ice10,hill2).
isBelow(ice12,ice13).
...
isRight(wood11,ice12).
isTower(struct0).
isTower(struct1).
isTower(struct2).
pig(pig0,504,342,10,10).
protects(struct2,pig0).
scene_scale(81,0.99486834).
...
shape(ice12,ball, 498,248,50,[4]).
shape(ice13,rect, 504,236,104,[6.33378937,16.55286083,2.0106193]).
...
shape(stone14,rect, 611.5,373,150,[6,25,0]).
shape(stone15,rect, 614,379.5,112,[7,16,0]).
shape(stone16,rect, 626.5,380,54,[6,9,0]).
...
shape(wood11,rect, 497.5,238,140,[5.93582545,23.70503251,2.04203522]).
situation_name('situation1_0-10-8-7-1').
