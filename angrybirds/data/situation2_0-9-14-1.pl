...
hasMaterial(ice11,ice,492,214,9,34).
hasMaterial(ice13,ice,500,204,4,4).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,388,344,24,6).
hasMaterial(stone1,stone,389,350,24,6).
hasMaterial(stone14,stone,512,189,25,5).
hasMaterial(stone15,stone,517,195,24,6).
...
hasMaterial(wood12,wood,491,193,26,12).
...
isAnchorPointFor(wood12,struct5).
isBelow(ice10,hill2).
...
shape(ice11,poly, 498,231,306,[4,[492,240],[496,248],[501,214],[500,216]]).
shape(ice13,poly, 502,209,16,[2,[500,208],[504,204]]).
...
shape(stone14,rect, 524.5,191.5,125,[5,25,0]).
shape(stone15,rect, 529,198,144,[6,24,0]).
...
shape(wood12,rect, 504,199,155,[6.28739396,24.72099509,0.28274334]).
situation_name('situation1_0-9-14-1').
