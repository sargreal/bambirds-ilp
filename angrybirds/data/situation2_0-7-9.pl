...
hasMaterial(stone0,stone,389,251,6,23).
...
hasMaterial(stone5,stone,393,275,24,7).
hasMaterial(stone7,stone,396,250,9,25).
hasMaterial(stone8,stone,403,250,9,25).
...
shape(redbird1,ball, 148.5,371.5,78,[5]).
shape(redbird2,ball, 129.5,375,103,[5.75]).
shape(stone0,poly, 393,262,138,[4,[389,253],[391,272],[394,274],[395,251]]).
...
shape(stone4,rect, 404,284.5,167,[6.92339658,24.14101304,0.06283185]).
shape(stone5,rect, 405,278.5,168,[7,24,0]).
shape(stone7,rect, 400.5,262.5,159,[6.34980504,25.17137406,1.66504411]).
shape(stone8,rect, 407.5,262.5,171,[6.83002084,25.053534,1.69646003]).
shape(stone9,rect, 414,263.5,150,[6,25,1.57079633]).
shape(wood13,rect, 509.5,192,150,[6,25,0]).
situation_name('situation1_0-7-9').
