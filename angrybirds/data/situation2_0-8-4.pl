...
hasMaterial(stone11,stone,486,227,5,24).
hasMaterial(stone12,stone,493,226,6,25).
...
shape(redbird1,ball, 145,375.5,103,[5.75]).
shape(redbird2,ball, 129.5,375,103,[5.75]).
shape(stone0,rect, 401.5,304,150,[6,25,0]).
shape(stone1,rect, 401.5,297.5,175,[7,25,0]).
shape(stone11,rect, 488.5,239,120,[5,24,1.57079633]).
shape(stone12,rect, 496,238.5,150,[6,25,1.57079633]).
...
situation_name('situation1_0-8-4').
