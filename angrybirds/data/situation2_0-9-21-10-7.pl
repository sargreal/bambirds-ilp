...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,482,195,31,6).
hasMaterial(ice11,ice,486,202,10,49).
hasMaterial(ice13,ice,516,196,13,5).
...
hasMaterial(stone14,stone,589,368,26,15).
hasMaterial(stone15,stone,607,377,25,6).
...
hasMaterial(wood12,wood,492,189,25,6).
...
shape(ice10,poly, 498,198,186,[4,[482,200],[483,201],[513,198],[513,195]]).
shape(ice11,rect, 491,226.5,334,[6.79781554,49.28005281,1.50796447]).
shape(ice13,rect, 522.5,198.5,60,[4.60137657,13.22463048,3.04734487]).
...
shape(stone14,rect, 602,375.5,159,[6.31490802,25.25963208,2.76460154]).
shape(stone15,rect, 619.5,380,150,[6,25,0]).
...
shape(wood12,rect, 504.5,192,150,[6,25,0]).
situation_name('situation1_0-9-21-10-7').
