...
hasMaterial(stone3,stone,389,281,25,7).
hasMaterial(stone4,stone,389,250,7,25).
hasMaterial(stone5,stone,390,275,25,6).
hasMaterial(stone7,stone,397,250,6,25).
hasMaterial(stone8,stone,404,250,6,25).
hasMaterial(stone9,stone,410,251,8,24).
...
isAnchorPointFor(stone18,struct5).
isAnchorPointFor(wood13,struct4).
isBelow(ice10,hill2).
isBelow(ice12,ice11).
...
shape(redbird1,ball, 144.5,368.5,95,[5.5]).
...
shape(stone3,rect, 401.5,284.5,175,[7,25,0]).
shape(stone4,rect, 392.5,262.5,175,[7,25,1.57079633]).
shape(stone5,rect, 402.5,278,150,[6,25,0]).
shape(stone7,rect, 400,262.5,150,[6,25,1.57079633]).
shape(stone8,rect, 407,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414,263,138,[5.74361988,24.14101304,1.63362818]).
shape(wood13,rect, 512.5,192,138,[6,23,0]).
situation_name('situation1_0-8-8').
