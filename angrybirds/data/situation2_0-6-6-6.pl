...
hasForm(stone9,bar).
hasForm(wood14,bar).
hasMaterial(ice11,ice,454,306,7,44).
hasMaterial(ice13,ice,492,203,22,45).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,388,343,24,7).
...
shape(ice11,poly, 458,331,308,[3,[454,306],[458,350],[461,313]]).
...
shape(stone0,rect, 400,346.5,168,[7,24,0]).
...
shape(stone6,rect, 400.5,311.5,166,[6.60944398,25.13903977,1.63362818]).
...
situation_name('situation1_0-6-6-6').
