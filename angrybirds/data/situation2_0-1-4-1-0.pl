...
hasMaterial(stone12,stone,575,366,23,17).
hasMaterial(stone13,stone,588,377,11,6).
hasMaterial(stone14,stone,597,377,7,6).
hasMaterial(stone15,stone,603,377,11,5).
...
shape(stone12,rect, 586.5,374.5,137,[5.59945557,24.53578017,2.6075219]).
shape(stone13,rect, 593.5,380,66,[6,11,0]).
shape(stone14,rect, 600.5,380,42,[6,7,0]).
shape(stone15,rect, 608.5,379.5,55,[5,11,0]).
...
situation_name('situation1_0-1-4-1-0').
