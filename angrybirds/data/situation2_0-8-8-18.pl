...
belongsTo(ice13,struct6).
belongsTo(pig0,struct5).
belongsTo(stone0,struct0).
belongsTo(stone1,struct0).
belongsTo(stone14,struct6).
belongsTo(stone15,struct7).
belongsTo(stone16,struct7).
...
hasMaterial(ice11,ice,487,200,1,1).
hasMaterial(ice12,ice,489,202,7,49).
hasMaterial(ice13,ice,521,198,11,3).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,388,344,24,6).
hasMaterial(stone1,stone,389,350,24,6).
hasMaterial(stone14,stone,523,183,23,19).
hasMaterial(stone15,stone,557,374,8,9).
hasMaterial(stone16,stone,567,377,15,5).
hasMaterial(stone2,stone,389,338,25,6).
hasMaterial(stone3,stone,390,332,25,6).
hasMaterial(stone4,stone,391,301,6,25).
hasMaterial(stone5,stone,392,326,24,6).
hasMaterial(stone6,stone,398,301,6,25).
hasMaterial(stone7,stone,404,301,7,25).
hasMaterial(stone8,stone,411,302,7,24).
hasMaterial(stone9,stone,452,245,24,6).
...
isAnchorPointFor(ice13,struct6).
isAnchorPointFor(pig0,struct5).
isAnchorPointFor(stone0,struct0).
isAnchorPointFor(stone15,struct7).
...
shape(ice11,poly, 498,199,1,[2,[487,200],[488,201]]).
shape(ice12,rect, 492.5,226.5,343,[7,49,1.57079633]).
shape(ice13,poly, 527,199,16.5,[5,[521,198],[523,201],[530,201],[532,200],[526,198]]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 129.5,375,103,[5.75]).
shape(stone0,rect, 400,347,144,[6,24,0]).
shape(stone1,rect, 401,353,144,[6,24,0]).
shape(stone14,rect, 534.5,192.5,114,[4.63287022,24.77588693,0.62831853]).
shape(stone15,rect, 560.5,378.5,32,[5.65685425,5.65685425,0.78539816]).
shape(stone16,rect, 574.5,379.5,75,[5,15,0]).
shape(stone2,rect, 401.5,341,150,[6,25,0]).
shape(stone3,rect, 402.5,335,150,[6,25,0]).
shape(stone4,rect, 394,313.5,150,[6,25,1.57079633]).
shape(stone5,rect, 404,329,144,[6,24,0]).
shape(stone6,rect, 401,313.5,150,[6,25,1.57079633]).
shape(stone7,rect, 407.5,313.5,175,[7,25,1.57079633]).
shape(stone8,rect, 414.5,314,168,[7,24,1.57079633]).
shape(stone9,rect, 464,248,144,[6,24,0]).
situation_name('situation1_0-8-8-18').
