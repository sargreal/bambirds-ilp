...
hasMaterial(ice11,ice,484,195,51,7).
hasMaterial(ice12,ice,490,213,11,39).
...
shape(ice11,rect, 509.5,198.5,357,[7,51,0]).
shape(ice12,rect, 495.5,232.5,280,[7.18193051,39.01513325,1.66504411]).
...
shape(stone15,rect, 507.5,176.5,166,[6.60045671,25.17886723,1.44513262]).
...
situation_name('situation1_0-9-21-8-4').
