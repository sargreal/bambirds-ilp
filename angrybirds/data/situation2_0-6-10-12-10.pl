...
hasMaterial(stone1,stone,388,343,25,6).
...
hasMaterial(stone3,stone,391,330,24,6).
hasMaterial(stone4,stone,395,323,10,7).
hasMaterial(stone5,stone,395,298,7,25).
hasMaterial(stone6,stone,404,324,15,6).
...
shape(stone1,rect, 400.5,346,150,[6,25,0]).
...
shape(stone3,rect, 403,333,144,[6,24,0]).
shape(stone4,rect, 400,326.5,70,[7,10,0]).
shape(stone5,rect, 398.5,310.5,158,[6.30873455,25.13903977,1.63362818]).
shape(stone6,rect, 411.5,327,90,[6,15,0]).
...
situation_name('situation1_0-6-10-12-10').
