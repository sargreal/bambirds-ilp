...
shape(ice10,rect, 458,330.5,306,[6,51,1.57079633]).
shape(ice11,rect, 509,198.5,350,[7,50,0]).
shape(ice12,rect, 495,226,288,[6,48,1.57079633]).
...
shape(stone14,rect, 501,176.5,150,[6,25,1.57079633]).
...
situation_name('situation1_0-6-9-3').
