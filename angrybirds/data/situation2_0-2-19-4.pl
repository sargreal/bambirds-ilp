...
hasMaterial(stone5,stone,393,325,22,19).
...
shape(stone2,rect, 396.5,320,135,[5.49865968,24.57235694,0.69115038]).
shape(stone3,rect, 400.5,353,150,[6,25,0]).
shape(stone4,rect, 400,315,120,[4.96951583,24.16303203,0.75398224]).
shape(stone5,rect, 404,334.5,120,[4.97501554,24.26058751,0.72256631]).
...
situation_name('situation1_0-2-19-4').
