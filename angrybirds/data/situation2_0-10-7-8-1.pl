...
hasMaterial(stone11,stone,574,366,25,17).
hasMaterial(stone12,stone,592,377,7,6).
hasMaterial(stone13,stone,597,376,9,8).
hasMaterial(stone14,stone,603,377,11,5).
...
shape(stone11,rect, 586.5,374.5,133,[5.43654142,24.57803738,2.63893783]).
shape(stone12,rect, 595.5,380,42,[6,7,0]).
shape(stone13,rect, 601.5,380,35,[5.65685425,6.36396103,0.78539816]).
shape(stone14,rect, 608.5,379.5,55,[5,11,0]).
...
situation_name('situation1_0-10-7-8-1').
