...
hasMaterial(stone11,stone,476,245,24,6).
hasMaterial(stone12,stone,480,232,24,6).
hasMaterial(stone13,stone,483,238,25,6).
...
shape(stone11,rect, 488,248,144,[6,24,0]).
shape(stone12,rect, 492,235,144,[6,24,0]).
shape(stone13,rect, 495.5,241,150,[6,25,0]).
...
situation_name('situation1_0-7-8-5').
