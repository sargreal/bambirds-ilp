...
hasMaterial(ice11,ice,495,219,21,30).
...
hasMaterial(stone12,stone,502,195,23,18).
hasMaterial(stone13,stone,512,181,20,19).
hasMaterial(stone14,stone,523,183,22,18).
...
hasMaterial(wood15,wood,580,377,25,6).
...
shape(ice11,rect, 505.5,234,187,[6.1755971,30.31763113,2.07345115]).
...
shape(stone12,rect, 513.5,204,102,[4.23995514,24.11369259,2.54469005]).
shape(stone13,rect, 522,190.5,85,[3.50232088,24.33420071,0.69115038]).
shape(stone14,rect, 534,192,118,[4.85193646,24.383799,0.65973446]).
...
shape(wood15,rect, 592.5,380,150,[6,25,0]).
situation_name('situation1_0-7-3-5-6').
