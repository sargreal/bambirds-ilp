...
hasForm(stone7,bar).
hasForm(stone8,bar).
hasMaterial(ice11,ice,492,243,6,8).
hasMaterial(ice12,ice,494,220,21,30).
...
hasMaterial(stone10,stone,486,228,16,22).
hasMaterial(stone13,stone,538,196,24,5).
hasMaterial(stone14,stone,602,377,25,6).
...
shape(ice11,poly, 496,247,24,[5,[492,249],[492,250],[497,251],[498,245],[496,243]]).
shape(ice12,rect, 504.5,235,208,[6.87750244,30.31763113,2.07345115]).
...
shape(stone10,rect, 494,239,116,[4.85484262,23.93348231,2.136283]).
shape(stone13,rect, 550,198.5,120,[5,24,0]).
shape(stone14,rect, 614.5,380,150,[6,25,0]).
...
situation_name('situation1_0-10-6-3-3').
