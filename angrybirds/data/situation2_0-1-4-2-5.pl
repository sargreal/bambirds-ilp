...
hasMaterial(ice14,ice,497,227,11,16).
...
hasMaterial(stone13,stone,471,227,18,25).
...
shape(ice14,rect, 502.5,235,79,[5.38306891,14.71084537,1.97920337]).
...
shape(stone13,rect, 480,239.5,149,[6.02519419,24.88748078,1.03672558]).
...
situation_name('situation1_0-1-4-2-5').
