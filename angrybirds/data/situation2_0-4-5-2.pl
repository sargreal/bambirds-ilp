...
hasForm(stone8,bar).
hasForm(wood13,bar).
hasMaterial(ice11,ice,489,212,13,39).
hasMaterial(ice12,ice,497,207,5,7).
...
hasMaterial(stone10,stone,460,245,25,6).
hasMaterial(stone14,stone,532,195,24,6).
hasMaterial(stone15,stone,534,189,24,6).
...
shape(ice11,rect, 495.5,231.5,255,[6.50278635,39.30201761,1.72787596]).
shape(ice12,poly, 500,210,35,[2,[497,207],[502,214]]).
...
shape(stone10,rect, 472.5,248,150,[6,25,0]).
shape(stone14,rect, 544,198,144,[6,24,0]).
shape(stone15,rect, 546,192,144,[6,24,0]).
...
shape(wood13,rect, 514.5,198.5,164,[6.54665346,25.13903977,3.0787608]).
situation_name('situation1_0-4-5-2').
