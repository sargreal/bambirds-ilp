...
hasMaterial(stone3,stone,390,337,24,7).
...
shape(redbird2,ball, 130,375.5,103,[5.75]).
...
shape(stone3,rect, 402,340.5,168,[7,24,0]).
...
situation_name('situation1_0-6-10').
