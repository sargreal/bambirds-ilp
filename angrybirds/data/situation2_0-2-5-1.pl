...
hasMaterial(ice14,ice,494,220,21,31).
...
isAnchorPointFor(ice14,struct4).
isAnchorPointFor(ice15,struct6).
...
shape(ice14,rect, 504.5,235.5,178,[5.58559361,31.98708497,2.136283]).
...
situation_name('situation1_0-2-5-1').
