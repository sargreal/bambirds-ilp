...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice11,ice,490,201,13,50).
...
hasMaterial(stone13,stone,509,171,6,24).
hasMaterial(stone14,stone,516,170,6,25).
...
hasMaterial(wood12,wood,501,196,25,6).
...
shape(ice11,rect, 496.5,226,360,[7.20602054,49.98173477,1.69646003]).
...
shape(stone13,rect, 512,183,144,[6,24,1.57079633]).
shape(stone14,rect, 519,182.5,149,[5.9656286,25.01907477,1.5393804]).
...
shape(wood12,rect, 513.5,199,150,[6,25,0]).
situation_name('situation1_0-6-10-5').
