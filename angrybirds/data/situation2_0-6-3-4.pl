...
hasMaterial(stone10,stone,457,245,24,6).
hasMaterial(stone11,stone,486,334,23,19).
...
hasMaterial(wood12,wood,536,195,25,6).
...
shape(stone10,rect, 469,248,144,[6,24,0]).
shape(stone11,rect, 497.5,343.5,144,[5.96674418,24.20655104,2.4818582]).
...
shape(wood12,rect, 548.5,198,150,[6,25,0]).
situation_name('situation1_0-6-3-4').
