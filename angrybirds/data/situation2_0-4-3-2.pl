...
hasMaterial(stone11,stone,427,245,24,6).
hasMaterial(stone13,stone,463,244,23,7).
hasMaterial(stone14,stone,470,238,25,6).
...
shape(stone11,rect, 439,248,144,[6,24,0]).
shape(stone13,rect, 474.5,247.5,161,[7,23,0]).
shape(stone14,rect, 482.5,241,150,[6,25,0]).
...
situation_name('situation1_0-4-3-2').
