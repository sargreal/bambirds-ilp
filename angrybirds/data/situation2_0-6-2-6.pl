...
hasMaterial(stone4,stone,391,330,24,6).
hasMaterial(stone5,stone,393,323,25,7).
hasMaterial(stone6,stone,396,299,9,24).
...
shape(stone13,rect, 502,176,141,[5.86257933,24.14101304,1.50796447]).
...
shape(stone4,rect, 403,333,144,[6,24,0]).
shape(stone5,rect, 405.5,326.5,175,[7,25,0]).
shape(stone6,rect, 400.5,311,163,[6.79781554,24.07822252,1.63362818]).
...
situation_name('situation1_0-6-2-6').
