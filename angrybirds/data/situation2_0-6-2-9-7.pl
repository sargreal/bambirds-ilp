...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice11,ice,490,202,15,50).
...
hasMaterial(stone13,stone,585,377,25,6).
hasMaterial(stone14,stone,643,377,25,6).
...
hasMaterial(wood12,wood,501,194,25,9).
...
shape(ice11,rect, 497.5,227,337,[6.93310864,48.64883855,1.75929189]).
...
shape(stone13,rect, 597.5,380,150,[6,25,0]).
shape(stone14,rect, 655.5,380,150,[6,25,0]).
...
shape(wood12,rect, 513.5,198.5,162,[6.49048453,25.01345873,3.0787608]).
situation_name('situation1_0-6-2-9-7').
