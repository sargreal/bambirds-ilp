...
hasMaterial(ice12,ice,491,206,32,45).
hasMaterial(ice13,ice,501,196,9,5).
...
hasMaterial(stone14,stone,521,176,20,17).
hasMaterial(stone15,stone,536,169,22,20).
hasMaterial(stone16,stone,542,185,20,21).
...
isAnchorPointFor(ice13,struct3).
...
shape(ice12,rect, 507,228.5,306,[6.05644568,50.5460986,2.136283]).
shape(ice13,poly, 512,199,45,[3,[501,196],[502,201],[510,197]]).
...
shape(stone14,rect, 531,184.5,90,[4.00758863,22.67156616,2.41902634]).
shape(stone15,rect, 547,179,135,[5.49865968,24.57235694,2.45044227]).
shape(stone16,rect, 552,195.5,106,[4.32306801,24.74430096,0.84823002]).
...
situation_name('situation1_0-9-6-1').
