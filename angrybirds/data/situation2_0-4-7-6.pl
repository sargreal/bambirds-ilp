...
hasForm(stone8,bar).
hasForm(wood13,bar).
hasMaterial(ice11,ice,491,215,12,33).
hasMaterial(ice12,ice,500,202,4,15).
...
hasMaterial(stone10,stone,461,245,23,6).
...
shape(ice11,rect, 497,231.5,225,[6.80646547,33.06301863,1.72787596]).
shape(ice12,rect, 502,209.5,60,[4,15,1.57079633]).
shape(ice9,rect, 458,330.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 129.5,372.5,95,[5.5]).
shape(stone0,rect, 400,347,144,[6,24,0]).
shape(stone1,rect, 401,353,144,[6,24,0]).
shape(stone10,rect, 472.5,248,138,[6,23,0]).
shape(stone14,rect, 512,183,144,[6,24,1.57079633]).
shape(stone15,rect, 519,182.5,150,[6,25,1.57079633]).
...
shape(wood13,rect, 514.5,198.5,166,[6.61606557,25.13903977,3.0787608]).
situation_name('situation1_0-4-7-6').
