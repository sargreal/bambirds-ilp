...
hasForm(stone7,bar).
hasForm(stone8,bar).
hasMaterial(ice10,ice,493,244,6,6).
hasMaterial(ice11,ice,495,219,21,29).
...
hasMaterial(stone12,stone,499,189,26,12).
hasMaterial(stone13,stone,501,200,17,22).
hasMaterial(stone14,stone,507,184,26,12).
...
shape(ice10,poly, 496,247,36,[4,[493,246],[493,247],[497,250],[499,244]]).
shape(ice11,rect, 505.5,233.5,166,[5.28477396,31.57905719,2.10486708]).
...
shape(stone12,rect, 512,195,153,[6.08636524,25.23551496,0.25132741]).
shape(stone13,rect, 509.5,211,121,[4.99457243,24.37868979,2.16769893]).
shape(stone14,rect, 520,190,147,[5.86385174,25.23551496,0.25132741]).
...
situation_name('situation1_0-6-3-8-4').
