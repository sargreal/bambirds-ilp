...
hasMaterial(stone0,stone,389,350,24,6).
hasMaterial(stone1,stone,389,343,24,7).
hasMaterial(stone10,stone,450,238,24,6).
...
shape(stone0,rect, 401,353,144,[6,24,0]).
shape(stone1,rect, 401,346.5,168,[7,24,0]).
shape(stone10,rect, 462,241,144,[6,24,0]).
...
shape(stone6,rect, 400.5,311.5,172,[6.87482544,25.07726574,1.66504411]).
...
situation_name('situation1_0-1-0-6-5').
