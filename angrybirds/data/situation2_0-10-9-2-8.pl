...
hasMaterial(stone7,stone,397,251,6,23).
...
shape(stone4,rect, 403,284.5,162,[6.73502502,24.07822252,0.06283185]).
shape(stone5,rect, 403,278,144,[6,24,0]).
shape(stone7,rect, 400,262.5,138,[6,23,1.57079633]).
...
situation_name('situation1_0-10-9-2-8').
