...
hasMaterial(stone3,stone,389,350,25,6).
hasMaterial(stone4,stone,389,299,6,25).
hasMaterial(stone5,stone,393,323,25,9).
hasMaterial(stone6,stone,397,299,7,25).
hasMaterial(stone7,stone,405,300,8,25).
hasMaterial(stone8,stone,419,328,6,25).
...
shape(stone3,rect, 401.5,353,150,[6,25,0]).
shape(stone4,rect, 392,311.5,150,[6,25,1.57079633]).
shape(stone5,rect, 405.5,327.5,169,[6.73502502,25.13903977,0.06283185]).
shape(stone6,rect, 400.5,311.5,155,[6.16991035,25.20183029,1.63362818]).
shape(stone7,rect, 409,312.5,146,[5.79978881,25.20183029,1.63362818]).
shape(stone8,rect, 422,340.5,150,[6,25,1.57079633]).
shape(wood13,rect, 505.5,192,150,[6,25,0]).
situation_name('situation1_0-7-8-6').
