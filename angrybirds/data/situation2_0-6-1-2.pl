...
hasMaterial(stone10,stone,455,245,25,6).
hasMaterial(stone11,stone,479,236,25,17).
hasMaterial(stone12,stone,482,232,25,16).
hasMaterial(stone2,stone,389,336,24,7).
hasMaterial(stone3,stone,390,330,24,7).
hasMaterial(stone4,stone,391,299,6,24).
...
shape(stone10,rect, 467.5,248,150,[6,25,0]).
shape(stone11,rect, 491.5,244.5,172,[6.97166047,24.68268741,0.40840704]).
shape(stone12,rect, 494.5,240,148,[6.23090741,23.88839163,0.40840704]).
shape(stone2,rect, 401,339.5,168,[7,24,0]).
shape(stone3,rect, 402,333.5,168,[7,24,0]).
shape(stone4,rect, 394,311,144,[6,24,1.57079633]).
...
situation_name('situation1_0-6-1-2').
