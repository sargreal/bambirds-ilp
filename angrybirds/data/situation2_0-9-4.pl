...
hasMaterial(ice12,ice,481,195,44,7).
...
hasMaterial(stone16,stone,498,164,9,25).
hasMaterial(stone17,stone,507,164,6,24).
...
hasMaterial(wood14,wood,493,189,26,6).
...
shape(ice12,rect, 503,198.5,308,[7,44,0]).
...
shape(stone16,rect, 502.5,176.5,162,[6.49048453,25.07624925,1.50796447]).
shape(stone17,rect, 510,176,144,[6,24,1.57079633]).
...
shape(wood14,rect, 506,192,156,[6,26,0]).
situation_name('situation1_0-9-4').
