...
hasMaterial(stone11,stone,497,240,26,16).
hasMaterial(stone12,stone,557,363,11,7).
hasMaterial(stone13,stone,564,366,18,11).
hasMaterial(stone14,stone,580,377,13,6).
hasMaterial(stone15,stone,592,377,10,6).
...
shape(stone11,rect, 510,248,143,[5.68352931,25.20329414,2.73318561]).
shape(stone12,rect, 562.5,366.5,43,[4.75528258,9.17754264,0.31415927]).
shape(stone13,rect, 573,371.5,93,[5.57865892,16.71704654,0.37699112]).
shape(stone14,rect, 586.5,380,78,[6,13,0]).
shape(stone15,rect, 597,380,60,[6,10,0]).
...
situation_name('situation1_0-1-6-1').
