...
hasMaterial(ice12,ice,490,196,10,5).
hasMaterial(ice13,ice,493,221,5,27).
hasMaterial(ice14,ice,496,205,4,20).
hasMaterial(ice19,ice,522,197,15,4).
...
hasMaterial(stone16,stone,500,164,6,24).
hasMaterial(stone17,stone,508,164,6,24).
hasMaterial(stone18,stone,516,163,5,25).
...
hasMaterial(wood15,wood,500,189,25,6).
...
shape(ice12,poly, 502,198,50,[4,[490,200],[491,201],[500,196],[499,199]]).
shape(ice13,rect, 495.5,234.5,135,[5,27,1.57079633]).
shape(ice14,rect, 498,215,80,[4,20,1.57079633]).
shape(ice19,rect, 529.5,199,60,[4,15,0]).
shape(ice7,rect, 401,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 160.5,375.5,95,[5.5]).
shape(redbird2,ball, 145,375,113,[6]).
shape(redbird3,ball, 129.5,368,103,[5.75]).
...
shape(stone16,rect, 503,176,144,[6,24,1.57079633]).
shape(stone17,rect, 511,176,144,[6,24,1.57079633]).
shape(stone18,rect, 518.5,175.5,125,[5,25,1.57079633]).
...
shape(wood15,rect, 512.5,192,150,[6,25,0]).
situation_name('situation1_0-4').
