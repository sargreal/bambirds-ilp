...
hasMaterial(stone11,stone,492,226,5,25).
hasMaterial(stone12,stone,533,189,24,6).
hasMaterial(stone13,stone,536,195,25,6).
...
hasMaterial(stone6,stone,396,250,8,25).
...
shape(stone11,rect, 494.5,238.5,125,[5,25,1.57079633]).
shape(stone12,rect, 545,192,144,[6,24,0]).
shape(stone13,rect, 548.5,198,150,[6,25,0]).
...
shape(stone6,rect, 400,262.5,147,[5.86257933,25.07624925,1.63362818]).
shape(stone8,rect, 407,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414,262.5,150,[6,25,1.57079633]).
situation_name('situation1_0-9-6-1-5').
