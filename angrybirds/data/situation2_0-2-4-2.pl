...
hasMaterial(ice13,ice,493,220,23,31).
hasMaterial(ice14,ice,515,211,0,0).
...
shape(ice13,rect, 504.5,235.5,185,[5.81291928,31.98708497,2.136283]).
shape(ice14,poly, 518,214,0,[1,[515,211]]).
...
situation_name('situation1_0-2-4-2').
