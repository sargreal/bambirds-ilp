...
hasMaterial(ice12,ice,482,196,27,5).
...
hasMaterial(stone14,stone,506,170,6,25).
hasMaterial(stone15,stone,522,182,22,20).
...
shape(ice12,rect, 495.5,198.5,135,[5,27,0]).
...
shape(stone14,rect, 509,182.5,150,[6,25,1.57079633]).
shape(stone15,rect, 533,192,106,[4.32306801,24.74430096,0.72256631]).
...
situation_name('situation1_0-9-8-4').
