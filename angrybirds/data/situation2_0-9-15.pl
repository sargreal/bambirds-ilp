...
hasMaterial(stone11,stone,456,238,25,6).
hasMaterial(stone12,stone,457,244,24,7).
...
shape(stone11,rect, 468.5,241,150,[6,25,0]).
shape(stone12,rect, 469,247.5,168,[7,24,0]).
...
situation_name('situation1_0-9-15').
