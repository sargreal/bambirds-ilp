...
hasMaterial(ice12,ice,486,195,23,8).
hasMaterial(ice13,ice,493,201,6,50).
...
hasMaterial(stone10,stone,449,245,25,6).
hasMaterial(stone15,stone,510,163,5,25).
hasMaterial(stone16,stone,516,163,6,25).
...
hasMaterial(wood14,wood,499,189,25,6).
...
shape(ice12,poly, 498,199,92,[6,[486,199],[487,203],[509,199],[509,195],[501,195],[496,199]]).
shape(ice13,rect, 496,226,300,[6,50,1.57079633]).
shape(ice6,rect, 400,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 132.5,372,103,[5.75]).
shape(stone0,rect, 401.5,304,150,[6,25,0]).
shape(stone1,rect, 401,298,144,[6,24,0]).
shape(stone10,rect, 461.5,248,150,[6,25,0]).
shape(stone15,rect, 512.5,175.5,125,[5,25,1.57079633]).
shape(stone16,rect, 519,175.5,150,[6,25,1.57079633]).
shape(stone2,rect, 401.5,291,198,[7.8703874,25.17137406,0.09424778]).
...
shape(wood14,rect, 511.5,192,150,[6,25,0]).
situation_name('situation1_0-10-4-6').
