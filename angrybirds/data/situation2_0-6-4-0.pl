...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,484,195,52,7).
hasMaterial(ice11,ice,492,202,9,50).
...
hasMaterial(stone13,stone,498,165,6,24).
hasMaterial(stone14,stone,503,164,9,25).
hasMaterial(stone15,stone,514,163,5,25).
...
shape(ice10,rect, 510,198.5,364,[7,52,0]).
shape(ice11,rect, 496.5,227,327,[6.5567953,50.00673878,1.60221225]).
...
shape(stone13,rect, 501,177,144,[6,24,1.57079633]).
shape(stone14,rect, 507.5,176.5,163,[6.49048453,25.13903977,1.50796447]).
shape(stone15,rect, 516.5,175.5,125,[5,25,1.57079633]).
...
situation_name('situation1_0-6-4-0').
