...
hasMaterial(stone12,stone,497,244,16,12).
hasMaterial(stone13,stone,511,241,12,9).
hasMaterial(stone15,stone,522,171,5,24).
hasMaterial(stone16,stone,577,377,25,6).
...
hasMaterial(wood14,wood,521,195,25,6).
...
isAnchorPointFor(stone12,struct3).
...
shape(stone12,rect, 505,250,82,[5.43091152,15.19803434,2.67035376]).
shape(stone13,rect, 517,245.5,53,[4.95994655,10.72602724,2.67035376]).
shape(stone15,rect, 524.5,183,120,[5,24,1.57079633]).
shape(stone16,rect, 589.5,380,150,[6,25,0]).
...
shape(wood14,rect, 533.5,198,150,[6,25,0]).
situation_name('situation1_0-1-20').
