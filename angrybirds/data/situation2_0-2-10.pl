...
hasMaterial(ice16,ice,489,242,10,10).
hasMaterial(ice17,ice,496,228,11,19).
hasMaterial(ice18,ice,512,210,9,8).
...
hasMaterial(stone11,stone,442,244,24,7).
hasMaterial(stone12,stone,450,238,25,6).
hasMaterial(stone14,stone,471,227,9,12).
hasMaterial(stone15,stone,475,236,12,14).
...
isAnchorPointFor(ice18,struct4).
...
isLeft(stone12,stone15).
isLeft(stone15,ice16).
isLeft(stone2,hill2).
isLeft(stone3,hill2).
...
shape(ice16,rect, 494,247,40,[5.65685425,7.07106781,2.35619449]).
shape(ice17,poly, 502,238,104.5,[5,[496,246],[498,247],[507,230],[505,228],[498,239]]).
shape(ice18,rect, 516.5,214,35,[4.94974747,7.07106781,2.35619449]).
...
shape(stone11,rect, 454,247.5,168,[7,24,0]).
shape(stone12,rect, 462.5,241,150,[6,25,0]).
shape(stone14,rect, 475.5,233,53,[4.94297207,10.72602724,1.09955743]).
shape(stone15,rect, 481,243,78,[5.52061888,14.1912238,1.00530965]).
...
situation_name('situation1_0-2-10').
