...
hasMaterial(stone12,stone,474,245,25,6).
hasMaterial(stone13,stone,497,232,26,14).
hasMaterial(stone14,stone,536,196,25,5).
...
shape(stone12,rect, 486.5,248,150,[6,25,0]).
shape(stone13,rect, 510,239,142,[5.57865892,25.62775664,2.76460154]).
shape(stone14,rect, 548.5,198.5,125,[5,25,0]).
...
situation_name('situation1_0-9-3-9').
