...
hasMaterial(stone10,stone,497,240,26,16).
hasMaterial(stone12,stone,577,377,25,6).
hasMaterial(stone13,stone,658,377,10,5).
hasMaterial(stone14,stone,668,376,15,6).
...
hasMaterial(wood11,wood,538,195,25,6).
...
isAnchorPointFor(stone13,struct6).
...
shape(stone10,rect, 510,248,143,[5.68352931,25.20329414,2.73318561]).
shape(stone12,rect, 589.5,380,150,[6,25,0]).
shape(stone13,rect, 663,379.5,50,[5,10,0]).
shape(stone14,rect, 675.5,379,90,[6,15,0]).
...
shape(wood11,rect, 550.5,198,150,[6,25,0]).
situation_name('situation1_0-6-5-5-6').
