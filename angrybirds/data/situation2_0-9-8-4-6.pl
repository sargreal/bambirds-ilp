...
hasMaterial(ice12,ice,481,196,28,7).
hasMaterial(ice13,ice,490,202,6,49).
hasMaterial(ice15,ice,520,197,13,4).
...
hasMaterial(stone14,stone,505,170,5,25).
hasMaterial(stone16,stone,522,182,21,20).
...
shape(ice12,poly, 495,199,98,[4,[481,198],[484,203],[508,199],[509,196]]).
shape(ice13,rect, 493,226.5,294,[6,49,1.57079633]).
shape(ice15,rect, 526.5,199,52,[4,13,0]).
...
shape(stone14,rect, 507.5,182.5,125,[5,25,1.57079633]).
shape(stone16,rect, 532.5,192,116,[4.8161458,24.1717883,0.72256631]).
...
situation_name('situation1_0-9-8-4-6').
