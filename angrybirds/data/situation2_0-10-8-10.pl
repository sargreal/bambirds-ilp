...
hasMaterial(ice11,ice,493,210,28,39).
...
hasMaterial(stone12,stone,533,189,24,6).
hasMaterial(stone13,stone,544,195,24,6).
...
shape(ice11,rect, 507,229.5,276,[6.59227247,41.95666914,2.136283]).
...
shape(stone12,rect, 545,192,144,[6,24,0]).
shape(stone13,rect, 556,198,144,[6,24,0]).
...
shape(stone9,rect, 413.5,263,161,[6.71384909,24.08238973,1.60221225]).
situation_name('situation1_0-10-8-10').
