...
hasMaterial(stone3,stone,389,300,8,24).
hasMaterial(stone4,stone,390,330,25,7).
hasMaterial(stone5,stone,393,324,24,6).
hasMaterial(stone6,stone,396,299,8,25).
...
shape(stone3,rect, 393,312,173,[7.17455866,24.20380356,1.50796447]).
shape(stone4,rect, 402.5,333.5,175,[7,25,0]).
shape(stone5,rect, 405,327,144,[6,24,0]).
shape(stone6,rect, 400,311.5,173,[6.93001816,25.01345873,1.50796447]).
...
situation_name('situation1_0-9-21-10').
