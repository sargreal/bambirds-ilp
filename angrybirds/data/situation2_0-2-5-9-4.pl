...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,489,195,49,7).
hasMaterial(ice11,ice,489,224,12,28).
hasMaterial(ice9,ice,455,306,6,50).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,387,343,25,7).
hasMaterial(stone1,stone,388,350,24,6).
hasMaterial(stone13,stone,501,164,5,25).
hasMaterial(stone14,stone,509,164,5,25).
hasMaterial(stone15,stone,516,163,5,25).
hasMaterial(stone2,stone,388,336,25,7).
hasMaterial(stone3,stone,389,330,25,6).
hasMaterial(stone4,stone,391,324,24,6).
hasMaterial(stone5,stone,395,299,6,25).
hasMaterial(stone6,stone,401,299,7,25).
hasMaterial(stone7,stone,408,299,6,25).
hasMaterial(stone8,stone,425,347,25,6).
hasMaterial(wood12,wood,499,189,25,6).
...
isAnchorPointFor(ice10,struct5).
isAnchorPointFor(ice11,struct3).
isAnchorPointFor(ice9,struct2).
...
shape(ice10,rect, 513.5,198.5,343,[7,49,0]).
shape(ice11,rect, 495,238,168,[6.31386681,26.66375641,1.75929189]).
...
shape(stone1,rect, 400,353,144,[6,24,0]).
shape(stone13,rect, 503.5,176.5,125,[5,25,1.57079633]).
shape(stone14,rect, 511.5,176.5,125,[5,25,1.57079633]).
shape(stone15,rect, 518.5,175.5,125,[5,25,1.57079633]).
shape(stone2,rect, 400.5,339.5,175,[7,25,0]).
shape(stone3,rect, 401.5,333,150,[6,25,0]).
shape(stone4,rect, 403,327,144,[6,24,0]).
shape(stone5,rect, 398,311.5,150,[6,25,1.57079633]).
shape(stone6,rect, 404.5,311.5,175,[7,25,1.57079633]).
shape(stone7,rect, 411,311.5,150,[6,25,1.57079633]).
shape(stone8,rect, 437.5,350,150,[6,25,0]).
shape(wood12,rect, 511.5,192,150,[6,25,0]).
situation_name('situation1_0-2-5-9-4').
