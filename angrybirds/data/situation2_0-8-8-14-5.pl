...
hasMaterial(stone11,stone,561,377,16,6).
hasMaterial(stone12,stone,614,377,10,6).
hasMaterial(stone13,stone,624,377,11,6).
...
shape(stone11,rect, 569,380,96,[6,16,0]).
shape(stone12,rect, 619,380,60,[6,10,0]).
shape(stone13,rect, 629.5,380,66,[6,11,0]).
...
situation_name('situation1_0-8-8-14-5').
