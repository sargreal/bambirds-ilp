...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,485,195,32,6).
hasMaterial(ice11,ice,489,202,7,49).
...
hasMaterial(stone13,stone,604,370,25,6).
hasMaterial(stone14,stone,608,377,25,6).
...
hasMaterial(wood12,wood,496,189,24,6).
...
shape(ice10,rect, 501,198,192,[6,32,0]).
shape(ice11,rect, 492.5,226.5,314,[6.3997415,49.10146449,1.5393804]).
...
shape(stone13,rect, 616.5,373,150,[6,25,0]).
shape(stone14,rect, 620.5,380,150,[6,25,0]).
...
shape(wood12,rect, 508,192,144,[6,24,0]).
situation_name('situation1_0-9-21-5').
