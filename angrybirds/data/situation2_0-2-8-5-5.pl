...
hasMaterial(ice14,ice,491,245,5,6).
hasMaterial(ice15,ice,494,220,21,31).
...
hasMaterial(stone13,stone,483,226,5,25).
hasMaterial(stone2,stone,389,288,25,7).
hasMaterial(stone3,stone,389,282,26,6).
hasMaterial(stone4,stone,389,251,6,24).
hasMaterial(stone5,stone,390,275,25,7).
hasMaterial(stone7,stone,397,251,7,24).
hasMaterial(stone8,stone,404,251,7,25).
hasMaterial(stone9,stone,411,251,7,25).
...
isAnchorPointFor(wood16,struct5).
isBelow(ice12,hill2).
isBelow(ice14,ice15).
isBelow(ice6,stone0).
...
shape(ice14,rect, 493.5,248,30,[5,6,1.57079633]).
shape(ice15,rect, 504.5,235.5,178,[5.58559361,31.98708497,2.136283]).
...
shape(stone13,rect, 485.5,238.5,125,[5,25,1.57079633]).
shape(stone2,rect, 401.5,291.5,175,[7,25,0]).
shape(stone3,rect, 402,285,156,[6,26,0]).
shape(stone4,rect, 392,263,144,[6,24,1.57079633]).
shape(stone5,rect, 402.5,278.5,171,[6.83949213,25.01907477,0.03141593]).
shape(stone7,rect, 400.5,263,156,[6.49048453,24.14101304,1.63362818]).
shape(stone8,rect, 407.5,263.5,175,[7,25,1.57079633]).
shape(stone9,rect, 414.5,263.5,175,[7,25,1.57079633]).
shape(wood16,rect, 524.5,198,150,[6,25,0]).
situation_name('situation1_0-2-8-5-5').
