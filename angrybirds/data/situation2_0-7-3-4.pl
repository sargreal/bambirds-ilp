...
hasMaterial(stone10,stone,450,233,25,18).
hasMaterial(stone12,stone,475,226,6,25).
hasMaterial(stone13,stone,481,226,6,25).
...
shape(stone10,rect, 462.5,242,145,[5.82679442,24.97259038,2.63893783]).
shape(stone12,rect, 478,238.5,150,[6,25,1.57079633]).
shape(stone13,rect, 484,238.5,150,[6,25,1.57079633]).
...
situation_name('situation1_0-7-3-4').
