...
hasForm(stone8,bar).
hasForm(wood13,bar).
hasMaterial(ice10,ice,494,240,7,11).
hasMaterial(ice11,ice,496,215,6,19).
hasMaterial(ice12,ice,500,203,4,11).
...
hasMaterial(stone14,stone,509,170,6,25).
hasMaterial(stone15,stone,517,170,5,25).
...
shape(ice10,rect, 497.5,245.5,44,[3.90366705,11.38951411,1.35088484]).
shape(ice11,poly, 500,231,114,[4,[496,231],[500,234],[502,215],[498,215]]).
shape(ice12,rect, 502,208.5,44,[4,11,1.57079633]).
...
shape(stone14,rect, 512,182.5,147,[5.90280708,25.05048553,1.5393804]).
shape(stone15,rect, 519.5,182.5,125,[5,25,1.57079633]).
...
shape(wood13,rect, 514.5,198.5,167,[6.67885609,25.07624925,3.0787608]).
situation_name('situation1_0-5-1-2-2').
