...
hasMaterial(ice12,ice,490,203,16,49).
...
hasMaterial(stone11,stone,462,245,24,6).
hasMaterial(stone14,stone,590,377,16,6).
hasMaterial(stone15,stone,605,377,10,5).
hasMaterial(stone16,stone,633,377,10,5).
hasMaterial(stone17,stone,642,377,16,6).
hasMaterial(stone2,stone,389,288,25,7).
hasMaterial(stone3,stone,389,282,25,6).
hasMaterial(stone4,stone,389,251,7,25).
hasMaterial(stone5,stone,390,276,25,6).
hasMaterial(stone7,stone,397,251,6,25).
hasMaterial(stone8,stone,403,251,9,25).
hasMaterial(stone9,stone,411,252,7,24).
hasMaterial(wood13,wood,502,194,25,9).
...
shape(ice12,rect, 498,227.5,356,[7.44987191,47.85393262,1.75929189]).
...
shape(stone11,rect, 474,248,144,[6,24,0]).
shape(stone14,rect, 598,380,96,[6,16,0]).
shape(stone15,rect, 610,379.5,50,[5,10,0]).
shape(stone16,rect, 638,379.5,50,[5,10,0]).
shape(stone17,rect, 650,380,96,[6,16,0]).
shape(stone2,rect, 401.5,291.5,175,[7,25,0]).
shape(stone3,rect, 401.5,285,150,[6,25,0]).
shape(stone4,rect, 392.5,263.5,175,[7,25,1.57079633]).
shape(stone5,rect, 402.5,279,150,[6,25,0]).
shape(stone7,rect, 400,263.5,150,[6,25,1.57079633]).
shape(stone8,rect, 407.5,263.5,167,[6.67885609,25.01345873,1.63362818]).
shape(stone9,rect, 414.5,264,168,[7,24,1.57079633]).
shape(wood13,rect, 514.5,198.5,167,[6.6722345,25.13903977,3.0787608]).
situation_name('situation1_0-7-1-7').
