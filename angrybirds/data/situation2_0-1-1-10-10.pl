...
hasMaterial(stone0,stone,389,250,6,25).
hasMaterial(stone1,stone,391,301,24,7).
hasMaterial(stone10,stone,441,245,25,6).
hasMaterial(stone11,stone,450,238,25,6).
hasMaterial(stone13,stone,484,226,5,25).
hasMaterial(stone2,stone,391,293,24,9).
hasMaterial(stone3,stone,392,288,24,7).
hasMaterial(stone4,stone,392,281,24,7).
hasMaterial(stone5,stone,392,274,25,9).
hasMaterial(stone7,stone,396,253,9,22).
...
shape(stone0,rect, 392,262.5,150,[6,25,1.57079633]).
shape(stone1,rect, 403,304.5,168,[7,24,0]).
...
shape(stone2,rect, 403,297.5,165,[6.82034661,24.2699204,0.09424778]).
shape(stone3,rect, 404,291.5,168,[7,24,0]).
shape(stone4,rect, 404,284.5,168,[7,24,0]).
shape(stone5,rect, 404.5,278.5,167,[6.67885609,25.07624925,0.06283185]).
shape(stone7,rect, 400.5,264,135,[6.16158841,21.99647153,1.66504411]).
shape(stone8,rect, 406.5,263,159,[6.61606557,24.14101304,1.63362818]).
shape(stone9,rect, 413.5,263.5,167,[6.6722345,25.07624925,1.63362818]).
shape(wood15,rect, 520.5,198.5,165,[6.54267809,25.31794638,2.98451302]).
situation_name('situation1_0-1-1-10-10').
