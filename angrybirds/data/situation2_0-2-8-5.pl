...
hasMaterial(stone13,stone,472,227,16,24).
...
shape(stone13,rect, 480,239,143,[5.81700412,24.59603903,1.09955743]).
...
situation_name('situation1_0-2-8-5').
