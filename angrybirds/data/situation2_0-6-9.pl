...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,484,195,50,7).
hasMaterial(ice11,ice,491,202,5,49).
...
hasMaterial(stone13,stone,498,164,5,25).
hasMaterial(stone14,stone,504,164,6,25).
hasMaterial(stone15,stone,513,163,5,25).
...
shape(ice10,rect, 509,198.5,350,[7,50,0]).
shape(ice11,rect, 493.5,226.5,245,[5,49,1.57079633]).
...
shape(stone13,rect, 500.5,176.5,125,[5,25,1.57079633]).
shape(stone14,rect, 507,176.5,150,[6,25,1.57079633]).
shape(stone15,rect, 515.5,175.5,125,[5,25,1.57079633]).
...
situation_name('situation1_0-6-9').
