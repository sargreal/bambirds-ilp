...
hasMaterial(ice13,ice,484,203,40,51).
...
hasMaterial(stone10,stone,421,244,24,7).
hasMaterial(stone11,stone,429,238,24,6).
...
shape(ice13,rect, 504,228.5,700,[13.28918184,52.69196323,2.16769893]).
...
shape(stone10,rect, 433,247.5,168,[7,24,0]).
shape(stone11,rect, 441,241,144,[6,24,0]).
...
situation_name('situation1_0-1-16-25-6').
