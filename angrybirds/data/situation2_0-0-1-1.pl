...
hasMaterial(ice13,ice,492,247,5,3).
hasMaterial(ice14,ice,494,217,22,32).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,388,343,25,7).
hasMaterial(stone1,stone,389,350,24,6).
hasMaterial(stone10,stone,454,237,25,7).
hasMaterial(stone12,stone,464,232,24,5).
...
shape(ice13,poly, 495,246,15,[4,[492,248],[492,249],[496,250],[497,247]]).
shape(ice14,rect, 505,233,186,[5.64573937,32.94884063,2.10486708]).
...
shape(stone10,rect, 466.5,240.5,175,[7,25,0]).
shape(stone12,rect, 476,234.5,120,[5,24,0]).
...
shape(stone9,rect, 465,247.5,168,[7,24,0]).
shape(wood15,rect, 543.5,198,150,[6,25,0]).
situation_name('situation1_0-0-1-1').
