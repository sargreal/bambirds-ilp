...
shape(redbird2,ball, 130,375,113,[6]).
...
shape(stone7,rect, 409,312.5,148,[5.92536985,25.07624925,1.63362818]).
shape(stone8,rect, 422,340.5,150,[6,25,1.57079633]).
shape(wood12,rect, 509.5,192,150,[6,25,0]).
situation_name('situation1_0-7-6').
