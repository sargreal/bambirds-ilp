...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice11,ice,492,215,11,33).
...
hasMaterial(stone13,stone,589,376,26,7).
...
hasMaterial(wood12,wood,502,195,25,7).
...
shape(ice11,rect, 497.5,231.5,206,[6.18991742,33.37588756,1.72787596]).
...
shape(stone13,rect, 602,379.5,178,[6.87090289,26.01858133,3.11017673]).
...
shape(wood12,rect, 514.5,198.5,159,[6.3582819,25.13903977,3.0787608]).
situation_name('situation1_0-6-4-5-8').
