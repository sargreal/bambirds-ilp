...
hasMaterial(pig0,pork,504,341,9,9).
hasMaterial(stone0,stone,389,301,25,6).
hasMaterial(stone1,stone,389,295,24,6).
hasMaterial(stone11,stone,457,245,24,6).
hasMaterial(stone12,stone,486,334,23,19).
...
isTower(struct0).
isTower(struct1).
pig(pig0,504,341,9,9).
protects(struct3,pig0).
scene_scale(81,0.99556783).
...
shape(pig0,ball, 509,346,132,[6.5]).
...
shape(stone11,rect, 469,248,144,[6,24,0]).
shape(stone12,rect, 497.5,343.5,144,[5.96674418,24.20655104,2.4818582]).
...
situation_name('situation1_0-5-7-3').
