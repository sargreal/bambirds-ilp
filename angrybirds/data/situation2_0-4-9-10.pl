...
hasMaterial(ice12,ice,490,202,16,49).
...
hasMaterial(stone11,stone,461,245,25,6).
hasMaterial(stone14,stone,529,189,25,6).
hasMaterial(stone15,stone,530,195,24,6).
...
hasMaterial(wood13,wood,502,195,24,7).
...
shape(ice12,rect, 498,226.5,347,[7.05753347,49.25636317,1.75929189]).
...
shape(stone11,rect, 473.5,248,150,[6,25,0]).
shape(stone14,rect, 541.5,192,150,[6,25,0]).
shape(stone15,rect, 542,198,144,[6,24,0]).
...
shape(wood13,rect, 514,198.5,153,[6.36490349,24.14101304,3.0787608]).
situation_name('situation1_0-4-9-10').
