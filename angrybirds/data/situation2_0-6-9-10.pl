...
hasMaterial(ice8,ice,455,305,6,48).
hasMaterial(ice9,ice,484,195,50,7).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,366,335,24,18).
...
hasMaterial(stone2,stone,389,350,24,6).
hasMaterial(stone3,stone,389,337,26,6).
hasMaterial(stone4,stone,403,311,6,26).
hasMaterial(stone5,stone,416,334,25,6).
hasMaterial(stone6,stone,420,340,24,7).
hasMaterial(stone7,stone,428,347,25,6).
...
isRight(stone5,stone3).
isTower(struct2).
pig(pig0,504,342,10,10).
protects(struct2,pig0).
scene_scale(81,0.99284658).
...
shape(ice8,rect, 458,329,288,[6,48,1.57079633]).
...
shape(stone0,rect, 378,344,142,[5.67349358,25.04482158,2.6075219]).
...
shape(stone2,rect, 401,353,144,[6,24,0]).
shape(stone3,rect, 402,340,156,[6,26,0]).
shape(stone4,rect, 406,324,156,[6,26,1.57079633]).
shape(stone5,rect, 428.5,337,150,[6,25,0]).
shape(stone6,rect, 432,343.5,168,[7,24,0]).
shape(stone7,rect, 440.5,350,150,[6,25,0]).
shape(wood11,rect, 509.5,192,150,[6,25,0]).
situation_name('situation1_0-6-9-10').
