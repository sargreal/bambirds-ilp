...
hasMaterial(stone10,stone,461,245,25,6).
hasMaterial(stone11,stone,481,235,22,17).
hasMaterial(stone12,stone,561,377,25,6).
hasMaterial(stone2,stone,389,298,6,25).
hasMaterial(stone3,stone,390,336,24,7).
hasMaterial(stone4,stone,392,330,24,6).
...
shape(stone10,rect, 473.5,248,150,[6,25,0]).
shape(stone11,rect, 492,243.5,102,[4.09502857,24.94077317,0.5969026]).
...
shape(stone4,rect, 404,333,144,[6,24,0]).
...
situation_name('situation1_0-6-6-3-2').
