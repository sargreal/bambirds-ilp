...
hasMaterial(stone0,stone,390,301,25,6).
hasMaterial(stone1,stone,390,295,25,6).
hasMaterial(stone11,stone,460,245,25,6).
hasMaterial(stone14,stone,509,171,6,24).
hasMaterial(stone15,stone,516,170,6,25).
hasMaterial(stone2,stone,390,288,25,7).
hasMaterial(stone3,stone,390,282,25,6).
hasMaterial(stone4,stone,391,274,23,9).
...
shape(stone0,rect, 402.5,304,150,[6,25,0]).
shape(stone1,rect, 402.5,298,150,[6,25,0]).
...
shape(stone2,rect, 402.5,291.5,175,[7,25,0]).
shape(stone3,rect, 402.5,285,150,[6,25,0]).
shape(stone4,rect, 402.5,278.5,156,[6.76586778,23.18025013,0.09424778]).
...
situation_name('situation1_0-4-10-19').
