...
hasMaterial(stone11,stone,467,244,24,7).
hasMaterial(stone12,stone,469,238,24,6).
hasMaterial(stone13,stone,476,232,25,6).
...
shape(stone11,rect, 479,247.5,168,[7,24,0]).
shape(stone12,rect, 481,241,144,[6,24,0]).
shape(stone13,rect, 488.5,235,150,[6,25,0]).
shape(stone2,rect, 401.5,291,150,[6,25,0]).
shape(stone3,rect, 401.5,284.5,175,[7,25,0]).
shape(stone4,rect, 392.5,262.5,172,[6.86060606,25.20183029,1.63362818]).
...
situation_name('situation1_0-10-7-4').
