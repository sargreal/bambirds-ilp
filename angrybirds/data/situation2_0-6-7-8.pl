...
hasForm(stone8,bar).
hasForm(wood13,bar).
hasMaterial(ice11,ice,479,195,32,6).
hasMaterial(ice12,ice,483,201,14,51).
...
hasMaterial(stone10,stone,463,244,25,7).
hasMaterial(stone14,stone,496,164,6,25).
hasMaterial(stone15,stone,503,164,6,24).
...
shape(ice11,rect, 495,198,192,[6,32,0]).
shape(ice12,rect, 490,226.5,345,[6.96590524,49.61628623,1.44513262]).
...
shape(stone10,rect, 475.5,247.5,175,[7,25,0]).
shape(stone14,rect, 499,176.5,148,[5.90280708,25.08189629,1.5393804]).
shape(stone15,rect, 506,176,144,[6,24,1.57079633]).
...
situation_name('situation1_0-6-7-8').
