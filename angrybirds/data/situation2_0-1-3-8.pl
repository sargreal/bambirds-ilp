...
hasMaterial(ice14,ice,491,243,8,8).
hasMaterial(ice15,ice,498,230,9,11).
hasMaterial(ice16,ice,507,219,9,9).
...
hasMaterial(stone13,stone,487,227,15,20).
hasMaterial(stone2,stone,389,288,25,7).
hasMaterial(stone3,stone,389,281,25,7).
hasMaterial(stone4,stone,389,274,25,9).
hasMaterial(stone5,stone,389,251,7,24).
hasMaterial(stone6,stone,397,250,6,25).
hasMaterial(stone8,stone,402,251,9,24).
...
isAnchorPointFor(ice16,struct5).
...
shape(ice14,rect, 495,247,35,[5.65685425,6.36396103,0.78539816]).
shape(ice15,poly, 503,235,49.5,[4,[498,237],[501,241],[507,230],[503,230]]).
shape(ice16,rect, 511,223.5,38,[4.94974747,7.77817459,2.35619449]).
...
shape(stone13,rect, 494.5,237,109,[5.55317178,19.72302862,2.10486708]).
shape(stone2,rect, 401.5,291.5,175,[7,25,0]).
shape(stone3,rect, 401.5,284.5,175,[7,25,0]).
shape(stone4,rect, 401.5,278.5,170,[6.79781554,25.13903977,0.06283185]).
shape(stone5,rect, 392.5,263,168,[7,24,1.57079633]).
shape(stone6,rect, 400,262.5,150,[6,25,1.57079633]).
shape(stone8,rect, 406.5,263,162,[6.73502502,24.14101304,1.63362818]).
shape(stone9,rect, 414,263.5,148,[5.92536985,25.07624925,1.63362818]).
situation_name('situation1_0-1-3-8').
