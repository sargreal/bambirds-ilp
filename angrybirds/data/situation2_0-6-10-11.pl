...
hasMaterial(stone2,stone,388,299,9,25).
hasMaterial(stone3,stone,391,336,24,7).
hasMaterial(stone4,stone,393,330,24,7).
hasMaterial(stone5,stone,394,324,25,6).
hasMaterial(stone6,stone,398,299,6,25).
hasMaterial(stone7,stone,404,299,7,25).
hasMaterial(stone8,stone,411,299,7,25).
...
shape(stone2,rect, 392.5,311.5,162,[6.49048453,25.07624925,1.50796447]).
shape(stone3,rect, 403,339.5,168,[7,24,0]).
shape(stone4,rect, 405,333.5,168,[7,24,0]).
...
shape(stone8,rect, 414.5,311.5,175,[7,25,1.57079633]).
shape(wood12,rect, 509.5,192,150,[6,25,0]).
situation_name('situation1_0-6-10-11').
