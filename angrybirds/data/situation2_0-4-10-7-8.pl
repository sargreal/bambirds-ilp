...
hasMaterial(ice12,ice,490,202,15,50).
...
hasMaterial(stone14,stone,512,170,6,25).
hasMaterial(stone15,stone,518,170,6,25).
...
hasMaterial(wood13,wood,504,194,22,9).
...
shape(ice12,rect, 497.5,227,331,[6.79727566,48.81695053,1.72787596]).
...
shape(stone14,rect, 515,182.5,150,[6,25,1.57079633]).
shape(stone15,rect, 521,182.5,150,[6,25,1.57079633]).
...
shape(wood13,rect, 515,198.5,140,[6.34980504,22.18468816,3.04734487]).
situation_name('situation1_0-4-10-7-8').
