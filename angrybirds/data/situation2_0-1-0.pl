...
hasMaterial(stone12,stone,521,170,8,25).
...
shape(redbird1,ball, 143,373.5,103,[5.75]).
...
shape(stone12,rect, 525,182.5,144,[5.74361988,25.20183029,1.63362818]).
...
situation_name('situation1_0-1-0').
