...
hasMaterial(stone11,stone,439,226,6,25).
hasMaterial(stone12,stone,446,226,6,25).
hasMaterial(stone14,stone,477,245,25,6).
...
shape(stone11,rect, 442,238.5,150,[6,25,1.57079633]).
shape(stone12,rect, 449,238.5,150,[6,25,1.57079633]).
shape(stone14,rect, 489.5,248,150,[6,25,0]).
...
situation_name('situation1_0-10-9-9-2').
