...
hasMaterial(stone5,stone,392,326,25,6).
hasMaterial(stone6,stone,398,301,6,25).
hasMaterial(stone7,stone,404,301,7,25).
hasMaterial(stone8,stone,410,302,9,24).
...
shape(redbird2,ball, 130,374,113,[6]).
...
shape(stone5,rect, 404.5,329,150,[6,25,0]).
shape(stone6,rect, 401,313.5,150,[6,25,1.57079633]).
shape(stone7,rect, 407.5,313.5,175,[7,25,1.57079633]).
shape(stone8,rect, 414.5,314,167,[6.92339658,24.20380356,1.63362818]).
shape(wood13,rect, 505.5,192,150,[6,25,0]).
situation_name('situation1_0-9-2').
