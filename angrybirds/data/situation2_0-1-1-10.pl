...
hasMaterial(stone4,stone,390,281,25,8).
...
shape(stone1,rect, 401.5,298,173,[6.87482544,25.17137406,0.09424778]).
...
shape(stone4,rect, 402.5,285,186,[7.41909915,25.07624925,0.06283185]).
...
situation_name('situation1_0-1-1-10').
