...
hasMaterial(ice12,ice,496,220,19,30).
...
hasMaterial(stone15,stone,518,178,22,18).
...
shape(ice12,rect, 505.5,235,186,[6.26279776,29.83587746,2.07345115]).
...
shape(stone15,rect, 529,187,114,[4.72957523,24.14578158,0.5969026]).
...
situation_name('situation1_0-10-9-5').
