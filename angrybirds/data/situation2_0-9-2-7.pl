...
hasMaterial(stone1,stone,389,350,16,6).
...
shape(stone1,rect, 397,353,96,[6,16,0]).
...
shape(stone3,rect, 402.5,340,150,[6,25,0]).
...
shape(stone7,rect, 409,353,60,[6,10,0]).
...
situation_name('situation1_0-9-2-7').
