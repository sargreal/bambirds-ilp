...
hasMaterial(ice11,ice,492,202,6,48).
...
shape(ice11,rect, 495,226,288,[6,48,1.57079633]).
...
shape(redbird2,ball, 129.5,369.5,95,[5.5]).
...
situation_name('situation1_0-6-4').
