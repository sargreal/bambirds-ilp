...
hasMaterial(ice13,ice,479,195,32,6).
hasMaterial(ice14,ice,483,201,14,51).
...
hasMaterial(stone12,stone,463,244,25,7).
hasMaterial(stone16,stone,496,164,6,25).
hasMaterial(stone17,stone,503,164,6,24).
...
hasMaterial(wood15,wood,489,189,26,6).
...
shape(ice13,rect, 495,198,192,[6,32,0]).
shape(ice14,rect, 490,226.5,345,[6.96590524,49.61628623,1.44513262]).
...
shape(stone12,rect, 475.5,247.5,175,[7,25,0]).
shape(stone16,rect, 499,176.5,150,[6,25,1.57079633]).
shape(stone17,rect, 506,176,144,[6,24,1.57079633]).
...
shape(wood15,rect, 502,192,156,[6,26,0]).
situation_name('situation1_0-9-5').
