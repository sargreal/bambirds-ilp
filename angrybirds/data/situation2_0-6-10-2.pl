...
hasForm(stone7,bar).
hasForm(stone8,bar).
hasMaterial(ice13,ice,491,228,17,23).
...
hasMaterial(stone10,stone,456,245,24,6).
hasMaterial(stone11,stone,466,219,6,25).
hasMaterial(stone12,stone,472,220,7,24).
...
shape(ice13,rect, 499.5,239.5,123,[4.98479209,24.77781024,2.136283]).
...
shape(stone10,rect, 468,248,144,[6,24,0]).
shape(stone11,rect, 469,231.5,150,[6,25,1.57079633]).
shape(stone12,rect, 475.5,232,154,[6.42769401,24.015432,1.63362818]).
...
situation_name('situation1_0-6-10-2').
