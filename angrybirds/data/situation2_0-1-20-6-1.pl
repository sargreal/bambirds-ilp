...
hasMaterial(stone11,stone,497,241,26,15).
...
shape(stone11,rect, 510,248.5,135,[5.38306891,25.20329414,2.73318561]).
...
situation_name('situation1_0-1-20-6-1').
