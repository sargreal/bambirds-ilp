...
hasMaterial(ice12,ice,479,195,45,6).
...
hasMaterial(stone15,stone,493,164,6,25).
hasMaterial(stone16,stone,499,164,6,25).
hasMaterial(stone17,stone,508,163,5,25).
...
shape(ice12,rect, 501.5,198,270,[6,45,0]).
shape(ice13,rect, 491.5,226.5,319,[6.48386294,49.21726229,1.50796447]).
...
shape(stone15,rect, 496,176.5,150,[6,25,1.57079633]).
shape(stone16,rect, 502,176.5,150,[6,25,1.57079633]).
shape(stone17,rect, 510.5,175.5,125,[5,25,1.57079633]).
...
situation_name('situation1_0-9-7').
