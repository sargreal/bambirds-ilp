...
hasMaterial(stone10,stone,427,236,26,15).
hasMaterial(stone11,stone,449,244,21,7).
hasMaterial(stone13,stone,453,238,25,6).
...
hasMaterial(stone7,stone,396,249,9,25).
hasMaterial(stone8,stone,404,251,7,24).
hasMaterial(stone9,stone,410,251,7,25).
hasMaterial(wood14,wood,498,248,24,6).
...
isAnchorPointFor(wood14,struct3).
isBelow(ice12,hill2).
isBelow(ice6,stone0).
...
isRight(wood14,hill2).
isTower(struct0).
isTower(struct1).
pig(pig0,504,342,10,10).
protects(struct3,pig0).
scene_scale(81,0.99602223).
...
shape(stone10,rect, 440,243.5,148,[5.96571368,24.89150753,2.76460154]).
shape(stone11,rect, 459.5,247.5,147,[7,21,0]).
shape(stone13,rect, 465.5,241,150,[6,25,0]).
shape(stone2,rect, 392.5,262,157,[6.49839219,24.17581209,1.66504411]).
...
shape(stone7,poly, 401,262,112.5,[5,[396,252],[398,272],[401,274],[405,252],[402,249]]).
shape(stone8,rect, 407.5,263,168,[7,24,1.57079633]).
shape(stone9,rect, 413.5,263.5,175,[7,25,1.57079633]).
shape(wood14,rect, 510,251,144,[6,24,0]).
situation_name('situation1_0-9-4-2-1').
