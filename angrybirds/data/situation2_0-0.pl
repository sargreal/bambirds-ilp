...
hasMaterial(ice14,ice,492,239,11,13).
hasMaterial(ice16,ice,496,220,18,22).
hasMaterial(ice7,ice,398,307,6,51).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,389,301,15,6).
hasMaterial(stone1,stone,389,295,25,7).
hasMaterial(stone10,stone,409,252,9,25).
hasMaterial(stone12,stone,453,244,24,7).
hasMaterial(stone13,stone,490,204,18,23).
hasMaterial(stone15,stone,492,214,18,22).
...
hasMaterial(wood17,wood,531,195,25,6).
...
isAnchorPointFor(wood17,struct5).
isBelow(ice11,hill2).
isBelow(ice14,ice16).
isBelow(ice14,stone15).
isBelow(ice16,stone13).
isBelow(ice16,stone15).
isBelow(ice7,stone0).
...
shape(ice14,rect, 497.5,245.5,48,[3.75078756,13.03839475,2.136283]).
shape(ice16,rect, 505,231,147,[6.41582537,23.02161482,2.16769893]).
shape(ice7,rect, 401,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 160.5,374.5,95,[5.5]).
shape(redbird2,ball, 144.5,375.5,95,[5.5]).
shape(redbird3,ball, 129.5,375,103,[5.75]).
shape(stone0,rect, 396.5,304,90,[6,15,0]).
shape(stone1,rect, 401.5,298.5,175,[7,25,0]).
shape(stone10,rect, 413.5,264.5,169,[6.73502502,25.13903977,1.63362818]).
shape(stone12,rect, 465,247.5,163,[6.80808137,24.08238973,3.11017673]).
shape(stone13,rect, 499,215.5,118,[4.90361662,24.16080798,2.136283]).
shape(stone15,rect, 501,225,116,[4.84110561,24.04277991,2.19911486]).
...
shape(stone6,rect, 400,264.5,143,[5.74575329,25.05048553,1.60221225]).
shape(stone8,rect, 409,304.5,50,[5,10,0]).
shape(stone9,rect, 407,264.5,150,[6,25,1.57079633]).
shape(wood17,rect, 543.5,198,150,[6,25,0]).
