...
hasMaterial(stone11,stone,519,189,24,6).
hasMaterial(stone12,stone,522,195,24,6).
...
shape(stone11,rect, 531,192,144,[6,24,0]).
shape(stone12,rect, 534,198,144,[6,24,0]).
...
shape(stone7,rect, 400,262.5,143,[5.73699829,25.07624925,1.63362818]).
shape(stone8,rect, 407,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414,262.5,150,[6,25,1.57079633]).
situation_name('situation1_0-8-7-8-2').
