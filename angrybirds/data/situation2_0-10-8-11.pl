...
hasMaterial(stone12,stone,490,331,20,21).
hasMaterial(stone13,stone,516,196,25,5).
...
shape(stone12,rect, 500,341.5,104,[4.24264069,24.74873734,2.35619449]).
shape(stone13,rect, 528.5,198.5,125,[5,25,0]).
...
situation_name('situation1_0-10-8-11').
