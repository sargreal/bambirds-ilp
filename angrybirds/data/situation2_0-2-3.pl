...
hasMaterial(ice13,ice,490,201,14,50).
...
hasMaterial(stone12,stone,461,245,24,6).
hasMaterial(stone15,stone,512,171,6,24).
hasMaterial(stone16,stone,518,170,6,25).
...
hasMaterial(wood14,wood,502,195,22,7).
...
shape(ice13,rect, 497,226,358,[7.17760576,50.01015489,1.72787596]).
shape(ice7,rect, 401,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 147.5,370,86,[5.25]).
shape(redbird2,ball, 129.5,374.5,95,[5.5]).
...
shape(stone12,rect, 473,248,144,[6,24,0]).
shape(stone15,rect, 515,183,144,[6,24,1.57079633]).
shape(stone16,rect, 521,182.5,150,[6,25,1.57079633]).
...
shape(wood14,poly, 514,199,77,[5,[502,201],[503,202],[524,201],[523,195],[506,197]]).
situation_name('situation1_0-2-3').
