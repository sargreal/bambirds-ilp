...
hasMaterial(ice13,ice,481,194,37,10).
hasMaterial(ice14,ice,490,202,6,49).
...
hasMaterial(stone11,stone,452,245,24,6).
hasMaterial(stone16,stone,508,172,25,17).
hasMaterial(stone17,stone,522,181,21,20).
...
hasMaterial(wood15,wood,496,189,25,6).
...
isAnchorPointFor(ice13,struct4).
...
shape(ice13,rect, 499.5,199,280,[7.54468019,37.17815103,3.0787608]).
shape(ice14,rect, 493,226.5,294,[6,49,1.57079633]).
shape(ice7,rect, 401,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 144.5,370.5,95,[5.5]).
...
shape(stone11,rect, 464,248,144,[6,24,0]).
shape(stone16,rect, 520.5,180.5,144,[5.78104409,24.97259038,2.63893783]).
shape(stone17,rect, 532.5,191,105,[4.27283412,24.7054462,0.69115038]).
...
shape(wood15,rect, 508.5,192,150,[6,25,0]).
situation_name('situation1_0-9-20').
