...
hasMaterial(ice11,ice,490,200,9,51).
...
hasMaterial(stone12,stone,561,377,22,6).
hasMaterial(stone13,stone,614,377,10,6).
hasMaterial(stone14,stone,624,377,11,6).
...
shape(ice11,rect, 494.5,225.5,341,[6.68243833,51.0376561,1.60221225]).
...
shape(stone12,rect, 572,380,132,[6,22,0]).
shape(stone13,rect, 619,380,60,[6,10,0]).
shape(stone14,rect, 629.5,380,66,[6,11,0]).
...
situation_name('situation1_0-8-8-14').
