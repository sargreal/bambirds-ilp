...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,488,195,30,7).
hasMaterial(ice11,ice,490,202,6,49).
hasMaterial(ice9,ice,455,305,6,51).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,388,343,25,6).
hasMaterial(stone1,stone,389,349,24,7).
hasMaterial(stone13,stone,498,164,6,25).
hasMaterial(stone14,stone,505,164,8,25).
hasMaterial(stone15,stone,523,181,21,20).
hasMaterial(stone2,stone,389,298,6,25).
hasMaterial(stone3,stone,390,336,24,7).
hasMaterial(stone4,stone,391,329,24,7).
hasMaterial(stone5,stone,392,323,25,6).
hasMaterial(stone6,stone,397,298,6,25).
hasMaterial(stone7,stone,404,298,7,25).
hasMaterial(stone8,stone,411,298,6,25).
...
shape(ice10,rect, 503,198.5,210,[7,30,0]).
...
shape(stone0,rect, 400.5,346,150,[6,25,0]).
shape(stone1,rect, 401,352.5,168,[7,24,0]).
shape(stone13,rect, 501,176.5,150,[6,25,1.57079633]).
shape(stone14,rect, 509,176.5,142,[5.68082936,25.13903977,1.63362818]).
shape(stone15,rect, 533.5,191,101,[4.19612568,24.11861051,0.75398224]).
shape(stone2,rect, 392,310.5,150,[6,25,1.57079633]).
shape(stone3,rect, 402,339.5,168,[7,24,0]).
shape(stone4,rect, 403,332.5,168,[7,24,0]).
shape(stone5,rect, 404.5,326,150,[6,25,0]).
shape(stone6,rect, 400,310.5,150,[6,25,1.57079633]).
shape(stone7,rect, 407.5,310.5,175,[7,25,1.57079633]).
shape(stone8,rect, 414,310.5,150,[6,25,1.57079633]).
shape(wood12,rect, 510.5,192,150,[6,25,0]).
situation_name('situation1_0-6-6-6-10').
