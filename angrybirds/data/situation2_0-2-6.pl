...
hasMaterial(ice15,ice,490,241,8,11).
hasMaterial(ice16,ice,494,218,23,30).
...
hasMaterial(stone14,stone,471,227,17,24).
...
shape(ice15,rect, 494,246.5,39,[4.03499107,9.83502072,2.04203522]).
shape(ice16,rect, 505.5,233,172,[5.24451922,32.83141289,2.136283]).
...
shape(stone14,rect, 479.5,239,118,[4.81275155,24.69312097,1.03672558]).
...
situation_name('situation1_0-2-6').
