...
hasForm(stone8,bar).
hasForm(wood12,bar).
hasMaterial(ice10,ice,485,195,50,7).
hasMaterial(ice11,ice,491,242,4,9).
...
hasMaterial(stone13,stone,498,164,8,24).
hasMaterial(stone14,stone,507,164,5,24).
hasMaterial(stone15,stone,515,163,5,25).
...
shape(ice10,rect, 510,198.5,350,[7,50,0]).
shape(ice11,poly, 496,233,36,[3,[491,242],[491,249],[495,251]]).
...
shape(stone13,rect, 502,176,141,[5.86257933,24.07822252,1.50796447]).
shape(stone14,rect, 509.5,176,120,[5,24,1.57079633]).
shape(stone15,rect, 517.5,175.5,125,[5,25,1.57079633]).
...
situation_name('situation1_0-2-5-9').
