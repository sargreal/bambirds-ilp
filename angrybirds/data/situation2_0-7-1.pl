...
hasMaterial(stone13,stone,522,171,5,24).
...
hasMaterial(wood12,wood,521,195,25,6).
...
shape(stone13,rect, 524.5,183,120,[5,24,1.57079633]).
...
shape(wood12,rect, 533.5,198,150,[6,25,0]).
situation_name('situation1_0-7-1').
