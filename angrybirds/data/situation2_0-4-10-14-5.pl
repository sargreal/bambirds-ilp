...
hasMaterial(stone3,stone,389,250,6,25).
hasMaterial(stone4,stone,390,281,24,7).
hasMaterial(stone5,stone,390,275,25,6).
hasMaterial(stone6,stone,395,250,9,25).
hasMaterial(stone8,stone,403,250,6,25).
hasMaterial(stone9,stone,412,250,5,25).
...
shape(stone3,rect, 392,262.5,150,[6,25,1.57079633]).
shape(stone4,rect, 402,284.5,168,[7,24,0]).
shape(stone5,rect, 402.5,278,150,[6,25,0]).
shape(stone6,rect, 399.5,262.5,172,[6.93001816,24.95066821,1.50796447]).
shape(stone8,rect, 406,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414.5,262.5,125,[5,25,1.57079633]).
shape(wood14,rect, 510,249,152,[6.15938929,24.67945836,2.82743339]).
situation_name('situation1_0-4-10-14-5').
