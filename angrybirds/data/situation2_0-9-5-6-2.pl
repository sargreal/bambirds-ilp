...
hasMaterial(ice11,ice,480,195,32,6).
hasMaterial(ice12,ice,484,201,12,51).
...
hasMaterial(stone14,stone,496,164,6,25).
hasMaterial(stone15,stone,504,164,5,25).
...
hasMaterial(wood13,wood,489,189,26,6).
...
shape(ice11,rect, 496,198,192,[6,32,0]).
shape(ice12,rect, 490,226.5,337,[6.76671384,49.8669527,1.44513262]).
...
shape(stone14,rect, 499,176.5,150,[6,25,1.57079633]).
shape(stone15,rect, 506.5,176.5,125,[5,25,1.57079633]).
...
shape(wood13,rect, 502,192,156,[6,26,0]).
situation_name('situation1_0-9-5-6-2').
