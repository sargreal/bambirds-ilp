...
hasMaterial(stone11,stone,537,177,5,24).
hasMaterial(stone12,stone,544,177,6,24).
hasMaterial(stone13,stone,561,377,25,6).
hasMaterial(stone2,stone,389,281,26,7).
hasMaterial(stone3,stone,389,249,7,25).
hasMaterial(stone4,stone,390,288,25,6).
...
shape(stone11,rect, 539.5,189,120,[5,24,1.57079633]).
shape(stone12,rect, 547,189,144,[6,24,1.57079633]).
shape(stone13,rect, 573.5,380,150,[6,25,0]).
shape(stone2,rect, 402,284.5,182,[7,26,0]).
shape(stone3,rect, 392.5,261.5,175,[7,25,1.57079633]).
shape(stone4,rect, 402.5,291,150,[6,25,0]).
...
situation_name('situation1_0-8-8-5-5').
