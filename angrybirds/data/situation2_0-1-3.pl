...
hasMaterial(stone12,stone,456,245,24,6).
hasMaterial(stone13,stone,466,219,6,25).
hasMaterial(stone14,stone,472,220,7,24).
...
shape(redbird1,ball, 146.5,373,86,[5.25]).
...
shape(stone12,rect, 468,248,144,[6,24,0]).
shape(stone13,rect, 469,231.5,150,[6,25,1.57079633]).
shape(stone14,rect, 475.5,232,154,[6.42769401,24.015432,1.63362818]).
...
situation_name('situation1_0-1-3').
