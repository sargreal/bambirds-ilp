...
hasForm(stone8,bar).
hasForm(wood15,bar).
hasMaterial(ice10,ice,492,241,8,10).
hasMaterial(ice11,ice,496,221,20,28).
...
hasMaterial(stone12,stone,502,197,17,24).
hasMaterial(stone13,stone,502,184,24,18).
hasMaterial(stone14,stone,511,182,24,16).
...
hasMaterial(wood15,wood,540,195,22,6).
...
shape(ice10,rect, 496,246,42,[5.85374199,7.21081696,2.16769893]).
shape(ice11,rect, 506,235,184,[6.26279776,29.52852512,2.07345115]).
shape(ice9,rect, 458,330.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 131,372,95,[5.5]).
shape(stone0,rect, 400,347,144,[6,24,0]).
shape(stone1,rect, 401,353,144,[6,24,0]).
shape(stone12,rect, 510.5,209,119,[4.90361662,24.46930911,2.136283]).
shape(stone13,rect, 514,193,149,[6.10849699,24.53578017,0.53407075]).
shape(stone14,rect, 523,190,143,[5.8339786,24.59603903,0.4712389]).
...
shape(wood15,rect, 551,198,132,[6,22,0]).
situation_name('situation1_0-6-3-8').
