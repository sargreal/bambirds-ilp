...
hasMaterial(ice11,ice,482,196,26,5).
hasMaterial(ice12,ice,490,202,6,49).
hasMaterial(ice14,ice,519,197,15,4).
...
hasMaterial(stone13,stone,507,170,5,25).
hasMaterial(stone15,stone,523,182,20,20).
...
shape(ice11,rect, 495,198.5,130,[5,26,0]).
shape(ice12,rect, 493,226.5,294,[6,49,1.57079633]).
shape(ice14,rect, 526.5,199,60,[4,15,0]).
...
shape(stone13,rect, 509.5,182.5,125,[5,25,1.57079633]).
shape(stone15,rect, 533,192,102,[4.24363314,24.1717883,0.72256631]).
...
situation_name('situation1_0-10-8-3-13').
