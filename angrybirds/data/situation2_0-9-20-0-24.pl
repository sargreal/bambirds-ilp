...
hasMaterial(ice12,ice,482,195,28,8).
...
hasMaterial(stone15,stone,501,183,24,5).
hasMaterial(stone16,stone,520,188,25,6).
...
hasMaterial(stone9,stone,409,250,10,27).
hasMaterial(wood14,wood,495,189,25,6).
...
shape(ice12,poly, 497,199,224,[6,[482,200],[483,201],[488,203],[510,195],[495,196],[493,199]]).
...
shape(stone15,rect, 513,185.5,120,[5,24,0]).
shape(stone16,rect, 532.5,191,150,[6,25,0]).
...
shape(stone9,rect, 414,263.5,179,[7.06304207,25.45369899,1.66504411]).
shape(wood14,rect, 507.5,192,150,[6,25,0]).
situation_name('situation1_0-9-20-0-24').
