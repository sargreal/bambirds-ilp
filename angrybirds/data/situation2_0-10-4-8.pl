...
hasMaterial(stone14,stone,533,189,25,6).
hasMaterial(stone15,stone,537,195,24,6).
...
shape(ice12,rect, 496.5,226,317,[6.53714971,48.62417153,1.69646003]).
...
shape(stone14,rect, 545.5,192,150,[6,25,0]).
shape(stone15,rect, 549,198,144,[6,24,0]).
...
shape(wood13,rect, 513.5,198.5,152,[6.0674801,25.17137406,3.04734487]).
situation_name('situation1_0-10-4-8').
