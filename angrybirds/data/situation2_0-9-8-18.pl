...
hasMaterial(ice12,ice,479,200,1,1).
hasMaterial(ice13,ice,486,201,10,50).
hasMaterial(ice16,ice,515,198,14,2).
...
hasMaterial(stone15,stone,499,163,5,25).
hasMaterial(stone17,stone,534,177,5,24).
...
isAnchorPointFor(stone17,struct6).
isAnchorPointFor(wood14,struct5).
isBelow(ice11,hill2).
...
shape(ice12,poly, 492,198,1,[2,[479,200],[480,201]]).
shape(ice13,rect, 491,226,318,[6.3582819,50.1524985,1.50796447]).
shape(ice16,poly, 523,199,28,[3,[515,199],[528,200],[529,198]]).
...
shape(stone15,rect, 501.5,175.5,125,[5,25,1.57079633]).
shape(stone17,rect, 536.5,189,120,[5,24,1.57079633]).
...
shape(wood14,rect, 505.5,192,147,[5.90280708,24.98766401,3.11017673]).
situation_name('situation1_0-9-8-18').
