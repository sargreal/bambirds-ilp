...
hasForm(stone8,bar).
hasForm(wood15,bar).
hasMaterial(ice10,ice,492,244,5,5).
hasMaterial(ice13,ice,496,220,20,29).
...
hasMaterial(stone11,stone,493,200,17,23).
hasMaterial(stone12,stone,496,209,17,22).
hasMaterial(stone14,stone,507,194,25,7).
...
shape(ice10,ball, 495.5,247.5,50,[4]).
shape(ice13,rect, 506,234.5,204,[6.91895277,29.52852512,2.07345115]).
...
shape(stone11,rect, 501.5,211.5,113,[4.59511549,24.77781024,2.136283]).
shape(stone12,rect, 504.5,220,101,[4.18923816,24.16080798,2.136283]).
shape(stone14,rect, 519.5,197.5,148,[5.92536985,25.13903977,0.06283185]).
...
situation_name('situation1_0-5-1-3').
