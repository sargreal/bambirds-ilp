...
hasMaterial(ice12,ice,482,195,52,7).
hasMaterial(ice13,ice,490,202,6,49).
...
hasMaterial(stone15,stone,499,164,5,25).
hasMaterial(stone16,stone,506,164,6,24).
hasMaterial(stone17,stone,511,164,9,24).
...
hasMaterial(wood14,wood,496,189,25,6).
...
shape(ice12,rect, 508,198.5,364,[7,52,0]).
shape(ice13,rect, 493,226.5,294,[6,49,1.57079633]).
...
shape(stone15,rect, 501.5,176.5,125,[5,25,1.57079633]).
shape(stone16,rect, 509,176,144,[6,24,1.57079633]).
shape(stone17,rect, 515.5,176,155,[6.44391335,24.08170378,1.66504411]).
...
shape(wood14,rect, 508.5,192,150,[6,25,0]).
situation_name('situation1_0-9-6').
