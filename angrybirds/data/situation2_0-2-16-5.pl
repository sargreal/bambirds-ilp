...
hasMaterial(stone11,stone,441,244,25,7).
hasMaterial(stone12,stone,450,238,25,6).
hasMaterial(stone14,stone,484,226,14,25).
...
shape(stone11,rect, 453.5,247.5,175,[7,25,0]).
shape(stone12,rect, 462.5,241,150,[6,25,0]).
shape(stone14,rect, 491,238.5,151,[6.14031085,24.69798015,1.94778745]).
...
situation_name('situation1_0-2-16-5').
