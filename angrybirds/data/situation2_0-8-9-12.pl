...
hasMaterial(ice14,ice,492,243,4,8).
...
hasMaterial(stone11,stone,467,217,20,22).
hasMaterial(stone12,stone,470,224,20,22).
hasMaterial(stone13,stone,474,231,18,19).
...
hasMaterial(stone7,stone,396,250,8,25).
hasMaterial(stone8,stone,405,250,6,25).
hasMaterial(stone9,stone,411,251,6,24).
hasMaterial(wood16,wood,494,211,18,23).
...
isLeft(ice14,ice15).
isLeft(stone1,hill2).
isLeft(stone12,ice14).
isLeft(stone12,wood16).
isLeft(stone13,ice14).
isLeft(stone13,ice15).
isLeft(stone13,wood16).
isLeft(stone2,hill2).
isLeft(stone3,hill2).
...
isRight(wood16,stone12).
isRight(wood16,stone13).
isTower(struct0).
isTower(struct1).
pig(pig0,504,342,10,10).
protects(struct2,pig0).
scene_scale(81,0.99559425).
...
shape(ice14,poly, 495,247,32,[4,[492,248],[492,249],[496,251],[496,243]]).
shape(ice15,poly, 502,238,104.5,[5,[496,246],[498,247],[507,230],[504,228],[498,236]]).
...
shape(stone11,rect, 477,228,139,[5.63174893,24.7054462,2.26194671]).
shape(stone12,rect, 480,235,136,[5.67228722,24.02976747,2.32477856]).
shape(stone13,rect, 483,240.5,97,[4.74740822,20.60703194,2.32477856]).
...
shape(stone7,rect, 400,262.5,147,[5.86257933,25.20183029,1.63362818]).
shape(stone8,rect, 408,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414,263,144,[6,24,1.57079633]).
shape(wood16,rect, 503,222.5,146,[6.21500614,23.55160922,2.16769893]).
situation_name('situation1_0-8-9-12').
