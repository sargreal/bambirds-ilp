...
hasMaterial(ice12,ice,489,195,32,6).
hasMaterial(ice13,ice,490,201,9,50).
...
hasMaterial(stone10,stone,452,245,24,6).
hasMaterial(stone15,stone,525,180,20,22).
hasMaterial(stone16,stone,679,376,9,8).
hasMaterial(stone17,stone,685,377,17,6).
...
hasMaterial(wood14,wood,503,189,24,5).
...
isAnchorPointFor(stone16,struct5).
isBelow(ice11,hill2).
...
isRight(stone15,ice12).
isRight(stone15,wood14).
...
shape(ice12,rect, 505,198,192,[6,32,0]).
shape(ice13,rect, 494.5,226,323,[6.46256302,50.03814954,1.60221225]).
...
shape(stone10,rect, 464,248,144,[6,24,0]).
shape(stone15,rect, 535,191,106,[4.40250288,24.26058751,0.84823002]).
shape(stone16,rect, 683.5,380,36,[5.65685425,6.36396103,0.78539816]).
shape(stone17,rect, 693.5,380,102,[6,17,0]).
...
shape(wood14,rect, 515,191.5,120,[5,24,0]).
situation_name('situation1_0-10-8-8').
