...
hasMaterial(stone14,stone,470,227,17,25).
...
shape(stone14,rect, 478.5,239.5,113,[4.47303407,25.45434406,1.0681415]).
...
situation_name('situation1_0-1-4-2').
