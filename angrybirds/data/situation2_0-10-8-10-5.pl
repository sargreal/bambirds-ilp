...
hasMaterial(ice9,ice,455,306,6,47).
...
hasMaterial(stone3,stone,389,330,24,7).
hasMaterial(stone4,stone,392,324,24,6).
hasMaterial(stone5,stone,395,299,8,25).
hasMaterial(stone6,stone,403,299,7,25).
hasMaterial(stone7,stone,410,299,6,25).
hasMaterial(stone8,stone,430,347,25,6).
...
shape(ice9,rect, 458,329.5,282,[6,47,1.57079633]).
...
shape(stone3,rect, 401,333.5,168,[7,24,0]).
shape(stone4,rect, 404,327,144,[6,24,0]).
shape(stone5,rect, 399,311.5,148,[5.92536985,25.07624925,1.63362818]).
shape(stone6,rect, 406.5,311.5,175,[7,25,1.57079633]).
shape(stone7,rect, 413,311.5,150,[6,25,1.57079633]).
shape(stone8,rect, 442.5,350,150,[6,25,0]).
situation_name('situation1_0-10-8-10-5').
