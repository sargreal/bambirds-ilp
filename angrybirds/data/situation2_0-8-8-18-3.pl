...
hasMaterial(ice11,ice,492,241,6,10).
hasMaterial(ice12,ice,494,218,22,31).
hasMaterial(pig0,pork,504,342,10,10).
hasMaterial(stone0,stone,388,344,24,6).
hasMaterial(stone1,stone,389,350,24,6).
hasMaterial(stone13,stone,518,195,24,6).
hasMaterial(stone14,stone,557,374,8,9).
hasMaterial(stone15,stone,567,377,15,5).
...
shape(ice11,rect, 495,246,60,[6,10,1.57079633]).
shape(ice12,rect, 505,233.5,187,[5.95115618,31.57905719,2.10486708]).
...
shape(stone13,rect, 530,198,144,[6,24,0]).
shape(stone14,rect, 560.5,378.5,32,[5.65685425,5.65685425,0.78539816]).
shape(stone15,rect, 574.5,379.5,75,[5,15,0]).
...
situation_name('situation1_0-8-8-18-3').
