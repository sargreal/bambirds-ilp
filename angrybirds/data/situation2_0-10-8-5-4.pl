...
hasMaterial(ice12,ice,479,195,33,6).
hasMaterial(ice13,ice,484,201,12,51).
...
hasMaterial(stone11,stone,463,245,25,6).
hasMaterial(stone15,stone,496,164,8,25).
hasMaterial(stone16,stone,505,163,12,26).
...
hasMaterial(wood14,wood,490,189,25,6).
...
shape(ice12,rect, 495.5,198,198,[6,33,0]).
shape(ice13,rect, 490,226.5,377,[7.62769195,49.53540277,1.47654855]).
...
shape(stone11,rect, 475.5,248,150,[6,25,0]).
shape(stone15,rect, 500,176.5,138,[5.4924578,25.13903977,1.63362818]).
shape(stone16,rect, 511,176,140,[5.56280908,25.23551496,1.82212374]).
...
shape(wood14,rect, 502.5,192,150,[6,25,0]).
situation_name('situation1_0-10-8-5-4').
