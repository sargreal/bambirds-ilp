...
hasMaterial(stone11,stone,428,236,25,15).
hasMaterial(stone12,stone,449,244,21,7).
hasMaterial(stone14,stone,453,238,25,6).
...
hasMaterial(wood15,wood,498,248,24,6).
...
isAnchorPointFor(wood15,struct3).
isBelow(ice13,hill2).
isBelow(ice7,stone0).
...
isRight(wood15,hill2).
isTower(struct0).
isTower(struct1).
pig(pig0,504,342,10,10).
protects(struct3,pig0).
scene_scale(81,0.99329026).
...
shape(hill2,poly, 458,281,4800,[10,[418,252],[419,310],[449,309],[450,302],[462,303],[463,310],[491,311],[493,307],[498,305],[497,251]]).
...
shape(redbird2,ball, 284,377,95,[5.5]).
...
shape(stone11,rect, 440.5,243.5,145,[5.96571368,24.3298556,2.76460154]).
shape(stone12,rect, 459.5,247.5,147,[7,21,0]).
shape(stone14,rect, 465.5,241,150,[6,25,0]).
...
shape(wood15,rect, 510,251,144,[6,24,0]).
situation_name('situation1_0-9-4-2').
