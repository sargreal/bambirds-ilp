...
hasMaterial(ice12,ice,491,201,6,50).
...
hasMaterial(stone13,stone,514,196,24,5).
hasMaterial(stone14,stone,561,377,25,6).
...
shape(ice12,rect, 494,226,300,[6,50,1.57079633]).
...
shape(stone0,rect, 401.5,303.5,165,[6.53802167,25.35959068,0.09424778]).
shape(stone1,rect, 401.5,297.5,175,[7,25,0]).
shape(stone10,rect, 464,248,144,[6,24,0]).
shape(stone13,rect, 526,198.5,120,[5,24,0]).
shape(stone14,rect, 573.5,380,150,[6,25,0]).
shape(stone2,rect, 392.5,261.5,164,[6.55327505,25.13903977,1.63362818]).
shape(stone3,rect, 402.5,291,181,[7.23072759,25.07624925,0.06283185]).
shape(stone4,rect, 403,284.5,168,[7,24,0]).
shape(stone5,rect, 404,278.5,168,[7,24,0]).
shape(stone7,rect, 400.5,262.5,171,[6.78071713,25.26548237,1.66504411]).
...
situation_name('situation1_0-7-7-13').
