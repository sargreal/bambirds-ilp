...
hasMaterial(ice15,ice,490,242,8,10).
hasMaterial(ice16,ice,493,217,23,34).
...
hasMaterial(stone11,stone,441,243,25,9).
hasMaterial(stone12,stone,443,238,25,6).
hasMaterial(stone14,stone,465,231,21,20).
...
hasMaterial(wood17,wood,512,195,25,6).
...
shape(ice15,rect, 494,247,41,[4.94297207,8.49002369,2.04203522]).
shape(ice16,rect, 504.5,234,203,[5.78455058,35.1793661,2.10486708]).
...
shape(stone11,rect, 453.5,247.5,169,[6.73502502,25.13903977,0.06283185]).
shape(stone12,rect, 455.5,241,150,[6,25,0]).
shape(stone14,rect, 475.5,241,124,[5.15261395,24.1717883,0.72256631]).
...
shape(wood17,rect, 524.5,198,150,[6,25,0]).
situation_name('situation1_0-1-23-7').
