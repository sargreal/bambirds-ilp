...
hasMaterial(stone10,stone,450,245,24,6).
hasMaterial(stone12,stone,514,195,24,6).
...
shape(stone10,rect, 462,248,144,[6,24,0]).
shape(stone12,rect, 526,198,144,[6,24,0]).
...
shape(stone8,rect, 406.5,262.5,174,[6.96513516,25.05048553,1.60221225]).
shape(stone9,rect, 414,262.5,150,[6,25,1.57079633]).
situation_name('situation1_0-9-3-10-5').
