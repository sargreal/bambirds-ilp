...
hasMaterial(stone11,stone,463,244,24,7).
hasMaterial(stone12,stone,465,231,25,6).
hasMaterial(stone13,stone,470,236,24,8).
...
shape(stone11,rect, 475,247.5,168,[7,24,0]).
shape(stone12,rect, 477.5,234,150,[6,25,0]).
shape(stone13,rect, 482,240,192,[8,24,0]).
...
situation_name('situation1_0-4-6-3').
