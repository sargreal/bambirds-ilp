...
shape(redbird1,ball, 130,369,113,[6]).
...
shape(stone6,rect, 400.5,311.5,166,[6.60944398,25.20183029,1.63362818]).
...
situation_name('situation1_0-1-0-6').
