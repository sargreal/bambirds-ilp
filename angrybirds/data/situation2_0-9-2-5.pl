...
hasForm(stone8,bar).
hasForm(wood13,bar).
hasMaterial(ice10,ice,477,196,11,9).
hasMaterial(ice11,ice,483,195,32,6).
...
hasMaterial(stone14,stone,599,370,16,6).
hasMaterial(stone15,stone,606,376,25,7).
hasMaterial(stone16,stone,613,371,11,5).
...
shape(ice10,rect, 482.5,200.5,44,[4.81275155,9.27380249,0.53407075]).
shape(ice11,rect, 499,198,192,[6,32,0]).
shape(ice12,rect, 491.5,226.5,325,[6.61961681,49.13287525,1.5393804]).
...
shape(stone14,rect, 607,373,96,[6,16,0]).
shape(stone15,rect, 618.5,379.5,175,[7,25,0]).
shape(stone16,rect, 618.5,373.5,55,[5,11,0]).
...
situation_name('situation1_0-9-2-5').
