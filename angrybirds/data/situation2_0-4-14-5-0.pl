...
hasMaterial(stone0,stone,389,300,25,7).
...
hasMaterial(stone5,stone,389,250,6,24).
hasMaterial(stone6,stone,396,250,6,24).
hasMaterial(stone8,stone,403,250,6,25).
hasMaterial(stone9,stone,411,250,6,24).
...
shape(stone0,rect, 401.5,303.5,161,[6.42769401,25.13903977,0.06283185]).
...
shape(stone5,rect, 392,262,144,[6,24,1.57079633]).
shape(stone6,rect, 399,262,144,[6,24,1.57079633]).
shape(stone8,rect, 406,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414,262,144,[6,24,1.57079633]).
shape(wood14,rect, 510,249,152,[6.15938929,24.67945836,2.82743339]).
situation_name('situation1_0-4-14-5-0').
