...
hasMaterial(stone11,stone,477,244,25,7).
hasMaterial(stone12,stone,479,238,24,6).
...
shape(stone11,rect, 489.5,247.5,175,[7,25,0]).
shape(stone12,rect, 491,241,144,[6,24,0]).
...
shape(stone9,rect, 413.5,263,161,[6.71384909,24.11380049,1.60221225]).
situation_name('situation1_0-10-1-3-1').
