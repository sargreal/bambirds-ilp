...
hasMaterial(stone11,stone,485,245,25,6).
hasMaterial(stone12,stone,533,196,25,5).
...
shape(stone11,rect, 497.5,248,150,[6,25,0]).
shape(stone12,rect, 545.5,198.5,125,[5,25,0]).
...
situation_name('situation1_0-8-12').
