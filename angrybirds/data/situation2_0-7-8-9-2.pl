...
hasMaterial(stone10,stone,439,226,6,25).
hasMaterial(stone11,stone,446,226,6,25).
hasMaterial(stone13,stone,478,245,24,6).
...
shape(stone10,rect, 442,238.5,150,[6,25,1.57079633]).
shape(stone11,rect, 449,238.5,150,[6,25,1.57079633]).
shape(stone13,rect, 490,248,144,[6,24,0]).
...
situation_name('situation1_0-7-8-9-2').
