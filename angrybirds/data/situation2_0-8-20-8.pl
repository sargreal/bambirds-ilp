...
hasMaterial(ice12,ice,477,196,11,9).
hasMaterial(ice13,ice,483,195,32,6).
hasMaterial(ice14,ice,487,202,9,49).
...
hasMaterial(stone16,stone,599,370,16,6).
hasMaterial(stone17,stone,606,376,25,7).
hasMaterial(stone18,stone,613,370,11,6).
...
shape(ice12,rect, 482.5,200.5,44,[4.81275155,9.27380249,0.53407075]).
shape(ice13,rect, 499,198,192,[6,32,0]).
shape(ice14,rect, 491.5,226.5,325,[6.61961681,49.13287525,1.5393804]).
shape(ice7,rect, 401,332.5,306,[6,51,1.57079633]).
shape(pig0,ball, 509,346.5,143,[6.75]).
shape(redbird0,ball, 196.5,327.5,78,[5]).
shape(redbird1,ball, 132.5,369,86,[5.25]).
...
shape(stone16,rect, 607,373,96,[6,16,0]).
shape(stone17,rect, 618.5,379.5,175,[7,25,0]).
shape(stone18,rect, 618.5,373,66,[6,11,0]).
...
situation_name('situation1_0-8-20-8').
