...
hasMaterial(stone5,stone,392,275,24,6).
hasMaterial(stone7,stone,398,250,5,25).
hasMaterial(stone8,stone,404,250,6,25).
hasMaterial(stone9,stone,410,250,9,25).
...
shape(stone5,rect, 404,278,144,[6,24,0]).
shape(stone7,rect, 400.5,262.5,125,[5,25,1.57079633]).
shape(stone8,rect, 407,262.5,150,[6,25,1.57079633]).
shape(stone9,rect, 414.5,262.5,173,[6.92339658,25.07624925,1.50796447]).
shape(wood13,rect, 513.5,199,150,[6,25,0]).
situation_name('situation1_0-9-7-9-11').
