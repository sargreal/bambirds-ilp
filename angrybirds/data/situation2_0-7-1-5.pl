...
hasMaterial(stone13,stone,472,227,15,24).
...
shape(stone13,rect, 479.5,239,112,[4.47303407,25.05979105,1.0681415]).
...
situation_name('situation1_0-7-1-5').
