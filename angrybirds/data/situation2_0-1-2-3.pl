...
hasMaterial(stone14,stone,577,377,25,6).
hasMaterial(stone15,stone,716,376,25,7).
...
shape(stone14,rect, 589.5,380,150,[6,25,0]).
shape(stone15,rect, 728.5,379.5,175,[7,25,0]).
...
shape(stone7,rect, 400.5,262.5,170,[6.78071713,25.17137406,1.66504411]).
...
situation_name('situation1_0-1-2-3').
