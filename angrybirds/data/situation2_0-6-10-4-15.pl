...
hasMaterial(stone11,stone,520,188,26,14).
hasMaterial(stone12,stone,530,183,26,15).
...
hasMaterial(wood10,wood,499,196,25,6).
...
shape(stone11,rect, 533,195,158,[6.4354994,24.61356598,0.34557519]).
shape(stone12,rect, 543,190.5,159,[6.31490802,25.25963208,0.37699112]).
...
shape(wood10,rect, 511.5,199,150,[6,25,0]).
situation_name('situation1_0-6-10-4-15').
