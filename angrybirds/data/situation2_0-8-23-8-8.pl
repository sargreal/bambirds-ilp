...
hasMaterial(ice11,ice,490,200,14,52).
...
hasMaterial(stone13,stone,516,183,23,19).
...
hasMaterial(wood12,wood,502,195,23,7).
...
shape(ice11,rect, 497,226,345,[6.79836734,50.8590674,1.69646003]).
...
shape(stone13,rect, 527.5,192.5,109,[4.41163848,24.77588693,0.62831853]).
...
shape(wood12,rect, 513.5,198.5,144,[6.29549138,22.95461475,3.0787608]).
situation_name('situation1_0-8-23-8-8').
