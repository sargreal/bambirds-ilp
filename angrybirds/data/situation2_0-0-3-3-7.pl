...
hasMaterial(ice14,ice,496,227,12,16).
...
hasMaterial(stone11,stone,455,244,25,7).
...
shape(ice14,rect, 502,235,98,[6.22725243,15.75457071,2.0106193]).
...
shape(stone11,rect, 467.5,247.5,175,[7,25,0]).
...
situation_name('situation1_0-0-3-3-7').
