...
hasMaterial(ice15,ice,493,209,28,40).
...
shape(ice15,rect, 507,229,276,[6.36494681,43.41799933,2.136283]).
...
shape(redbird2,ball, 129.5,372.5,95,[5.5]).
...
situation_name('situation1_0-1-4').
